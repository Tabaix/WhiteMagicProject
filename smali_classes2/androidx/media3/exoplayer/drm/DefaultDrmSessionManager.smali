...
.method private constructor <init>(Ljava/util/UUID;Landroidx/media3/exoplayer/drm/ExoMediaDrm$Provider;Landroidx/media3/exoplayer/drm/MediaDrmCallback;Ljava/util/HashMap;Z[IZLandroidx/media3/exoplayer/upstream/LoadErrorHandlingPolicy;J)V
    ...
    sget-object v0, Lua0;->c:Ljava/util/UUID;
...
.method public static synthetic access$1500(Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;Landroid/os/Looper;Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;Z)Landroidx/media3/exoplayer/drm/DrmSession;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->acquireSession(Landroid/os/Looper;Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;Z)Landroidx/media3/exoplayer/drm/DrmSession;
...
.method private acquireSession(Landroid/os/Looper;Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;Z)Landroidx/media3/exoplayer/drm/DrmSession;
    .locals 4
    ...
    iget-object p1, p3, Lx62;->s:Lhm1;

    if-nez p1, :cond_0

    iget-object p1, p3, Lx62;->o:Ljava/lang/String;
    ...
    invoke-static {p1, p3, v0}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->getSchemeDatas(Lhm1;Ljava/util/UUID;Z)Ljava/util/List;
    ...
    invoke-static {p0, p3, p1}, Lmx2;->c0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private canAcquireSession(Lhm1;)Z
    .locals 4
    ...
    invoke-static {p1, v0, v1}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->getSchemeDatas(Lhm1;Ljava/util/UUID;Z)Ljava/util/List;
    ...
    iget-object v0, p1, Lhm1;->c:[Lgm1;

    aget-object v0, v0, v2

    sget-object v3, Lua0;->c:Ljava/util/UUID;

    invoke-virtual {v0, v3}, Lgm1;->a(Ljava/util/UUID;)Z
...
.method private static getSchemeDatas(Lhm1;Ljava/util/UUID;Z)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, p1}, Lgm1;->a(Ljava/util/UUID;)Z
    ...
    invoke-virtual {v2, v3}, Lgm1;->a(Ljava/util/UUID;)Z
...
.method private verifyPlaybackThread(Z)V
    ...
    invoke-static {v0, p1, p0}, Lmx2;->E0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p0, p1}, Lmx2;->E0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method public acquireSession(Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;)Landroidx/media3/exoplayer/drm/DrmSession;
    .locals 3
    ...
    invoke-direct {p0, v0, p1, p2, v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->acquireSession(Landroid/os/Looper;Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;Z)Landroidx/media3/exoplayer/drm/DrmSession;
...
.method public getCryptoType(Lx62;)I
    .locals 5
    ...
    :cond_3
    invoke-direct {p0, v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->canAcquireSession(Lhm1;)Z
...
.method public preacquireSession(Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;)Landroidx/media3/exoplayer/drm/DrmSessionManager$DrmSessionReference;
    .locals 1
    ...
    invoke-virtual {v0, p2}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$PreacquiredSessionReference;->acquire(Lx62;)V
