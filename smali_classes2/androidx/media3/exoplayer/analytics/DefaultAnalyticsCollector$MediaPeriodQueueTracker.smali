...
.method public constructor <init>(Lfp6;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->period:Lfp6;
...
.method private addTimelineForMediaPeriodId(Lcom/google/common/collect/d0;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lip6;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p3, v0}, Lip6;->getIndexOfPeriod(Ljava/lang/Object;)I
    ...
    invoke-virtual {p1, p2, p3}, Lcom/google/common/collect/d0;->g(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/d0;
    ...
    invoke-virtual {p1, p2, p0}, Lcom/google/common/collect/d0;->g(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/d0;
...
.method private static findCurrentPlayerMediaPeriodInQueue(Lpy4;Lcom/google/common/collect/ImmutableList;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lfp6;)Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-virtual {v0, v1}, Lip6;->getUidOfPeriod(I)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v0, v1, p3}, Lip6;->getPeriod(ILfp6;)Lfp6;
    ...
    iget-wide v6, p3, Lfp6;->e:J

    sub-long/2addr v1, v6

    invoke-virtual {v0, v1, v2}, Lfp6;->b(J)I
...
.method private updateMediaPeriodTimelines(Lip6;)V
    .locals 4
    ...
    invoke-direct {p0, v0, v1, p1}, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->addTimelineForMediaPeriodId(Lcom/google/common/collect/d0;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lip6;)V
    ...
    invoke-direct {p0, v0, v2, p1}, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->addTimelineForMediaPeriodId(Lcom/google/common/collect/d0;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lip6;)V
...
.method public getMediaPeriodIdTimeline(Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;)Lip6;
    .locals 0
...
.method public onPositionDiscontinuity(Lpy4;)V
    .locals 3
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->period:Lfp6;

    invoke-static {p1, v0, v1, v2}, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->findCurrentPlayerMediaPeriodInQueue(Lpy4;Lcom/google/common/collect/ImmutableList;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lfp6;)Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;
...
.method public onQueueUpdated(Ljava/util/List;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;Lpy4;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->period:Lfp6;
    ...
    :cond_1
    invoke-interface {p3}, Lpy4;->getCurrentTimeline()Lip6;

    move-result-object p1

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$MediaPeriodQueueTracker;->updateMediaPeriodTimelines(Lip6;)V

    return-void
.end method

.method public onTimelineChanged(Lpy4;)V
    .locals 3
    ...
    invoke-interface {p1}, Lpy4;->getCurrentTimeline()Lip6;
