...
# instance fields
.field private final cueDecoder:Ln41;

.field private final cueDecoderInputBuffer:Lc81;
...
.field private nextSubtitle:Ltf6;

.field private nextSubtitleEventIndex:I

.field private nextSubtitleInputBuffer:Lsf6;
...
.field private streamFormat:Lx62;

.field private subtitle:Ltf6;

.field private subtitleDecoder:Lpf6;
...
.method public constructor <init>(Landroidx/media3/exoplayer/text/TextOutput;Landroid/os/Looper;Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoder:Ln41;
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoderInputBuffer:Lc81;
...
.method private assertLegacyDecodingEnabledIfRequired()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;
    ...
    :goto_1
    iget-object p0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;
...
.method private clearOutput()V
    ...
    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/text/TextRenderer;->updateOutput(Lo41;)V
...
.method private getCurrentEventTimeUs(J)J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    invoke-virtual {v0, p1, p2}, Ltf6;->d(J)I

    move-result p1

    if-eqz p1, :cond_2

    iget-object p2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    invoke-virtual {p2}, Ltf6;->k()I
    ...
    :cond_0
    iget-object p0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    const/4 p2, -0x1

    if-ne p1, p2, :cond_1

    invoke-virtual {p0}, Ltf6;->k()I

    move-result p1

    add-int/lit8 p1, p1, -0x1

    invoke-virtual {p0, p1}, Ltf6;->i(I)J
...
.method private getNextEventTime()J
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    invoke-virtual {v1}, Ltf6;->k()I
    ...
    invoke-virtual {v0, p0}, Ltf6;->i(I)J
...
.method private handleDecoderError(Landroidx/media3/extractor/text/SubtitleDecoderException;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;
    ...
    invoke-static {v1, v0, p1}, Lmx2;->c0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static hasEventsAfter(Lof6;J)Z
    .locals 4
...
.method private initSubtitleDecoder()V
    ...
    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;->createDecoder(Lx62;)Lpf6;

    move-result-object v0

    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Lpf6;
...
.method private invokeUpdateOutputInternal(Lo41;)V
    .locals 2

    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->output:Landroidx/media3/exoplayer/text/TextOutput;

    iget-object v1, p1, Lo41;->a:Lcom/google/common/collect/ImmutableList;
    ...
    invoke-interface {p0, p1}, Landroidx/media3/exoplayer/text/TextOutput;->onCues(Lo41;)V

    return-void
.end method

.method private static isCuesWithTiming(Lx62;)Z
    .locals 1
...
.method private readAndDecodeCuesWithTiming(J)Z
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoderInputBuffer:Lc81;

    invoke-virtual {p0, v0, v2, v1}, Landroidx/media3/exoplayer/BaseRenderer;->readSource(Landroidx/media3/exoplayer/FormatHolder;Lc81;I)I
    ...
    :cond_1
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoderInputBuffer:Lc81;
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoder:Ln41;

    iget-object v3, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoderInputBuffer:Lc81;

    iget-wide v6, v3, Lc81;->timeUs:J
    ...
    invoke-direct {v3, v1}, Lm41;-><init>(I)V
    ...
    invoke-direct/range {v4 .. v9}, Lp41;-><init>(Ljava/util/List;JJ)V
    ...
    invoke-interface {p0, v4, p1, p2}, Landroidx/media3/exoplayer/text/CuesResolver;->addCues(Lp41;J)Z
...
.method private releaseSubtitleBuffers()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Lsf6;
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    :cond_0
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ltf6;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Ld81;->release()V

    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ltf6;
...
.method private releaseSubtitleDecoder()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Lpf6;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {v0}, Lb81;->release()V
...
.method private renderFromCuesWithTiming(J)V
    ...
    invoke-direct {v3, v0}, Lo41;-><init>(Ljava/util/List;)V

    invoke-direct {p0, v3}, Landroidx/media3/exoplayer/text/TextRenderer;->updateOutput(Lo41;)V
...
.method private renderFromSubtitles(J)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ltf6;
    ...
    invoke-interface {v0, p1, p2}, Lpf6;->setPositionUs(J)V
    ...
    invoke-interface {v0}, Lb81;->dequeueOutputBuffer()Ljava/lang/Object;
    ...
    :cond_3
    iget-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ltf6;
    ...
    invoke-virtual {v0}, Ld81;->release()V

    :cond_6
    invoke-virtual {v4, p1, p2}, Ltf6;->d(J)I

    move-result v0

    iput v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleEventIndex:I

    iput-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    iput-object v5, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ltf6;
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ltf6;

    invoke-virtual {v4, p1, p2}, Ltf6;->g(J)Ljava/util/List;

    move-result-object p1

    invoke-direct {v0, p1}, Lo41;-><init>(Ljava/util/List;)V
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Lsf6;

    if-nez p1, :cond_b

    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Lpf6;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Lb81;->dequeueInputBuffer()Ljava/lang/Object;
    ...
    :cond_a
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Lsf6;
    ...
    invoke-virtual {p1, p2}, Lg80;->setFlags(I)V

    iget-object p2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Lpf6;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p2, p1}, Lb81;->queueInputBuffer(Ljava/lang/Object;)V

    iput-object v5, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Lsf6;
    ...
    invoke-virtual {p0, p2, p1, v2}, Landroidx/media3/exoplayer/BaseRenderer;->readSource(Landroidx/media3/exoplayer/FormatHolder;Lc81;I)I
    ...
    iget-object p2, p2, Landroidx/media3/exoplayer/FormatHolder;->format:Lx62;
    ...
    :cond_e
    iget-wide v6, p2, Lx62;->t:J

    iput-wide v6, p1, Lsf6;->c:J
...
.method private updateOutput(Lo41;)V
    .locals 1
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/text/TextRenderer;->invokeUpdateOutputInternal(Lo41;)V
...
.method public isReady()Z
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/text/TextRenderer;->isCuesWithTiming(Lx62;)Z
    ...
    invoke-static {v0, v3, v4}, Landroidx/media3/exoplayer/text/TextRenderer;->hasEventsAfter(Lof6;J)Z
    ...
    iget-object p0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Lsf6;
...
.method public onDisabled()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;
...
.method public onPositionReset(JZZ)V
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;

    if-eqz p1, :cond_2

    invoke-static {p1}, Landroidx/media3/exoplayer/text/TextRenderer;->isCuesWithTiming(Lx62;)Z
    ...
    invoke-interface {p1}, Lb81;->flush()V

    invoke-virtual {p0}, Landroidx/media3/exoplayer/BaseRenderer;->getLastResetPositionUs()J

    move-result-wide p2

    invoke-interface {p1, p2, p3}, Lb81;->setOutputStartTimeUs(J)V
...
.method public onStreamChanged([Lx62;JJLandroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;
...
.method public render(JJ)V
    ...
    :cond_1
    iget-object p3, p0, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Lx62;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p3}, Landroidx/media3/exoplayer/text/TextRenderer;->isCuesWithTiming(Lx62;)Z
...
.method public supportsFormat(Lx62;)I
    ...
    invoke-interface {p0, p1}, Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;->supportsFormat(Lx62;)Z
    ...
    invoke-static {p0}, Ln84;->k(Ljava/lang/String;)Z
