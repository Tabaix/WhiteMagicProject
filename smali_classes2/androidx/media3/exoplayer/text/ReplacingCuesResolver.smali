...
.method public addCues(Lp41;J)Z
    ...
    iget-wide v7, v5, Lp41;->b:J

    cmp-long v5, v2, v7

    iget-object v7, p0, Landroidx/media3/exoplayer/text/ReplacingCuesResolver;->cuesWithTimingList:Ljava/util/ArrayList;
...
.method public getCuesAtTimeUs(J)Lcom/google/common/collect/ImmutableList;
    ...
    :cond_2
    :goto_0
    iget-object p0, p0, Lp41;->a:Lcom/google/common/collect/ImmutableList;
...
.method public getNextCueChangeTimeUs(J)J
    ...
    iget-wide v8, v4, Lp41;->b:J

    iget-wide v4, v4, Lp41;->b:J
    ...
    :cond_4
    invoke-static {v5}, Lv42;->O(Ljava/lang/Iterable;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lp41;

    iget-wide v3, p0, Lp41;->d:J
