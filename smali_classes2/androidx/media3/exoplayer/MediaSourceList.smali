...
.field private final eventHandler:Lvg2;
...
.field private mediaTransferListener:Lls6;
...
# direct methods
.method public constructor <init>(Landroidx/media3/exoplayer/MediaSourceList$MediaSourceListInfoRefreshListener;Landroidx/media3/exoplayer/analytics/AnalyticsCollector;Lvg2;Landroidx/media3/exoplayer/analytics/PlayerId;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/media3/exoplayer/MediaSourceList;->eventHandler:Lvg2;
...
.method public static synthetic a(Landroidx/media3/exoplayer/MediaSourceList;Landroidx/media3/exoplayer/source/MediaSource;Lip6;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/MediaSourceList;->lambda$prepareChildSource$0(Landroidx/media3/exoplayer/source/MediaSource;Lip6;)V

    return-void
.end method

.method public static synthetic access$000(Landroidx/media3/exoplayer/MediaSourceList;)Lvg2;
    .locals 0

    iget-object p0, p0, Landroidx/media3/exoplayer/MediaSourceList;->eventHandler:Lvg2;
...
.method private synthetic lambda$prepareChildSource$0(Landroidx/media3/exoplayer/source/MediaSource;Lip6;)V
    .locals 0
...
.method private prepareChildSource(Landroidx/media3/exoplayer/MediaSourceList$MediaSourceHolder;)V
    ...
    iput-object p0, v1, Landroidx/media3/exoplayer/y;->c:Landroidx/media3/exoplayer/MediaSourceList;
    ...
    invoke-static {p1}, Lb17;->p(Landroid/os/Handler$Callback;)Landroid/os/Handler;
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/MediaSourceList;->mediaTransferListener:Lls6;

    iget-object p0, p0, Landroidx/media3/exoplayer/MediaSourceList;->playerId:Landroidx/media3/exoplayer/analytics/PlayerId;

    invoke-interface {v0, v1, p1, p0}, Landroidx/media3/exoplayer/source/MediaSource;->prepareSource(Landroidx/media3/exoplayer/source/MediaSource$MediaSourceCaller;Lls6;Landroidx/media3/exoplayer/analytics/PlayerId;)V
...
.method private removeMediaSourcesInternal(II)V
    ...
    invoke-virtual {v2}, Landroidx/media3/exoplayer/source/MaskingMediaSource;->getTimeline()Lip6;

    move-result-object v2

    invoke-virtual {v2}, Lip6;->getWindowCount()I
...
# virtual methods
.method public addMediaSources(ILjava/util/List;Landroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    invoke-virtual {v1}, Landroidx/media3/exoplayer/source/MaskingMediaSource;->getTimeline()Lip6;
    ...
    :cond_3
    invoke-virtual {p0}, Landroidx/media3/exoplayer/MediaSourceList;->createTimeline()Lip6;
...
.method public clear(Landroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 1
...
.method public createTimeline()Lip6;
    .locals 3
    ...
    sget-object p0, Lip6;->EMPTY:Lip6;
...
.method public moveMediaSource(IILandroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 1

    add-int/lit8 v0, p1, 0x1

    invoke-virtual {p0, p1, v0, p2, p3}, Landroidx/media3/exoplayer/MediaSourceList;->moveMediaSourceRange(IIILandroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
...
.method public moveMediaSourceRange(IIILandroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 3
    ...
    invoke-static {p1, v2, p2, p3}, Lb17;->M(ILjava/util/List;II)V
...
.method public prepare(Lls6;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/MediaSourceList;->mediaTransferListener:Lls6;
...
.method public release()V
    ...
    invoke-static {v3, v4, v2}, Lmx2;->c0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public removeMediaSourceRange(IILandroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 1
...
.method public setMediaSources(Ljava/util/List;Landroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroidx/media3/exoplayer/MediaSourceList;->addMediaSources(ILjava/util/List;Landroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
...
.method public setShuffleOrder(Landroidx/media3/exoplayer/source/ShuffleOrder;)Lip6;
    .locals 2
...
.method public updateMediaSourcesWithMediaItems(IILjava/util/List;)Lip6;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(II",
    ...
    invoke-virtual {v1, v2}, Landroidx/media3/exoplayer/source/MaskingMediaSource;->updateMediaItem(Lj24;)V
