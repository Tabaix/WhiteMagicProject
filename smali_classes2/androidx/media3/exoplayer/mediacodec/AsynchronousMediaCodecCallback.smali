...
# instance fields
.field private final availableInputBuffers:Lrm0;

.field private final availableOutputBuffers:Lrm0;
...
.method public constructor <init>(Landroid/os/HandlerThread;)V
    ...
    invoke-direct {p1}, Lrm0;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;->availableInputBuffers:Lrm0;

    new-instance p1, Lrm0;

    invoke-direct {p1}, Lrm0;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;->availableOutputBuffers:Lrm0;
...
.method private addOutputFormat(Landroid/media/MediaFormat;)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;->availableOutputBuffers:Lrm0;

    const/4 v1, -0x2

    invoke-virtual {v0, v1}, Lrm0;->a(I)V
...
.method private flushInternal()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;->availableInputBuffers:Lrm0;
...
.method public dequeueInputBufferIndex()I
    ...
    :cond_0
    iget-object p0, p0, Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;->availableInputBuffers:Lrm0;
...
.method public flush()V
    ...
    iput-object p0, v2, Landroidx/media3/exoplayer/mediacodec/c;->c:Landroidx/media3/exoplayer/mediacodec/AsynchronousMediaCodecCallback;
...
.method public onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    invoke-virtual {v0, p2}, Lrm0;->a(I)V
