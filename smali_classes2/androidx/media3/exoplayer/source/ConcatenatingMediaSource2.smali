...
# direct methods
.method private constructor <init>(Lj24;Lcom/google/common/collect/ImmutableList;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2;->mediaItem:Lj24;
...
.method public synthetic constructor <init>(Lj24;Lcom/google/common/collect/ImmutableList;Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2$1;)V
    .locals 0

    .line 15
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2;-><init>(Lj24;Lcom/google/common/collect/ImmutableList;)V
...
.method private maybeCreateConcatenatedTimeline()Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2$ConcatenatedTimeline;
    ...
    invoke-virtual {v9}, Landroidx/media3/exoplayer/source/MaskingMediaSource;->getTimeline()Lip6;

    move-result-object v9

    invoke-virtual {v9}, Lip6;->isEmpty()Z
    ...
    invoke-static {v11, v10}, Lkz4;->f(Ljava/lang/Object;Z)V

    invoke-virtual {v3, v9}, Lns2;->d(Ljava/lang/Object;)V

    invoke-static {v15}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v10

    invoke-virtual {v4, v10}, Lns2;->d(Ljava/lang/Object;)V

    invoke-virtual {v9}, Lip6;->getPeriodCount()I
    ...
    :goto_1
    invoke-virtual {v9}, Lip6;->getWindowCount()I

    move-result v11

    if-ge v10, v11, :cond_d

    invoke-virtual {v9, v10, v1}, Lip6;->getWindow(ILhp6;)Lhp6;

    if-nez v16, :cond_0

    iget-object v11, v1, Lhp6;->d:Ljava/lang/Object;
    ...
    iget-wide v3, v1, Lhp6;->l:J

    move-wide/from16 v22, v3

    iget-wide v3, v1, Lhp6;->p:J
    ...
    :goto_4
    iget-boolean v3, v1, Lhp6;->h:Z

    if-nez v3, :cond_5

    iget-boolean v3, v1, Lhp6;->k:Z
    ...
    invoke-virtual {v5, v4}, Lns2;->d(Ljava/lang/Object;)V

    move-object/from16 v0, v27

    const/4 v4, 0x1

    invoke-virtual {v0, v3, v2, v4}, Lip6;->getPeriod(ILfp6;Z)Lfp6;

    move-object/from16 v27, v5

    iget-wide v4, v2, Lfp6;->d:J
    ...
    :goto_9
    iget-object v5, v2, Lfp6;->b:Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2;->getMediaItem()Lj24;
    ...
    invoke-virtual/range {v31 .. v31}, Lrs2;->h()Lcom/google/common/collect/ImmutableList;

    move-result-object v16

    invoke-virtual/range {v27 .. v27}, Lrs2;->h()Lcom/google/common/collect/ImmutableList;
    ...
    :goto_d
    invoke-direct/range {v13 .. v24}, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2$ConcatenatedTimeline;-><init>(Lj24;Lcom/google/common/collect/ImmutableList;Lcom/google/common/collect/ImmutableList;Lcom/google/common/collect/ImmutableList;ZZJJLjava/lang/Object;)V
...
.method public getInitialTimeline()Lip6;
    .locals 0
...
.method public declared-synchronized getMediaItem()Lj24;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2;->mediaItem:Lj24;
    :try_end_0
...
.method public bridge synthetic onChildSourceInfoRefreshed(Ljava/lang/Object;Landroidx/media3/exoplayer/source/MediaSource;Lip6;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/source/ConcatenatingMediaSource2;->onChildSourceInfoRefreshed(Ljava/lang/Integer;Landroidx/media3/exoplayer/source/MediaSource;Lip6;)V
