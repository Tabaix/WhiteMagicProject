...
.method private maybeNotifyDownstreamFormat()V
    ...
    iget-object v0, v0, Landroidx/media3/exoplayer/source/SingleSampleMediaPeriod;->format:Lx62;
    ...
    iget-object v3, v0, Landroidx/media3/exoplayer/source/SingleSampleMediaPeriod;->format:Lx62;
    ...
    invoke-virtual/range {v1 .. v7}, Landroidx/media3/exoplayer/source/MediaSourceEventListener$EventDispatcher;->downstreamFormatChanged(ILx62;ILjava/lang/Object;J)V
...
.method public readData(Landroidx/media3/exoplayer/FormatHolder;Lc81;I)I
    ...
    invoke-virtual {p2, p0}, Lg80;->addFlag(I)V
    ...
    invoke-virtual {p2, v6}, Lg80;->addFlag(I)V
    ...
    invoke-virtual {p2, p1}, Lc81;->ensureSpaceForWrite(I)V

    iget-object p1, p2, Lc81;->data:Ljava/nio/ByteBuffer;
    ...
    :cond_6
    :goto_0
    iget-object p2, v0, Landroidx/media3/exoplayer/source/SingleSampleMediaPeriod;->format:Lx62;

    iput-object p2, p1, Landroidx/media3/exoplayer/FormatHolder;->format:Lx62;
