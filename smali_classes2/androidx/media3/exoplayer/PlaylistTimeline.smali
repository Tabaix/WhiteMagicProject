...
.method public constructor <init>(Ljava/util/Collection;Landroidx/media3/exoplayer/source/ShuffleOrder;)V
    ...
    .line 80
    invoke-static {p1}, Landroidx/media3/exoplayer/PlaylistTimeline;->getTimelines(Ljava/util/Collection;)[Lip6;
    ...
    invoke-direct {p0, v0, p1, p2}, Landroidx/media3/exoplayer/PlaylistTimeline;-><init>([Lip6;[Ljava/lang/Object;Landroidx/media3/exoplayer/source/ShuffleOrder;)V

    return-void
.end method

.method private constructor <init>([Lip6;[Ljava/lang/Object;Landroidx/media3/exoplayer/source/ShuffleOrder;)V
    .locals 7
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;
    ...
    iget-object v5, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;
    ...
    invoke-virtual {v4}, Lip6;->getWindowCount()I

    move-result v4

    add-int/2addr v1, v4

    iget-object v4, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;

    aget-object v4, v4, v3

    invoke-virtual {v4}, Lip6;->getPeriodCount()I
...
.method private static getTimelines(Ljava/util/Collection;)[Lip6;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v2}, Landroidx/media3/exoplayer/MediaSourceInfoHolder;->getTimeline()Lip6;
...
.method public copyWithPlaceholderTimeline(Landroidx/media3/exoplayer/source/ShuffleOrder;)Landroidx/media3/exoplayer/PlaylistTimeline;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;
    ...
    invoke-direct {v3, p0, v2}, Landroidx/media3/exoplayer/PlaylistTimeline$1;-><init>(Landroidx/media3/exoplayer/PlaylistTimeline;Lip6;)V
    ...
    invoke-direct {v1, v0, p0, p1}, Landroidx/media3/exoplayer/PlaylistTimeline;-><init>([Lip6;[Ljava/lang/Object;Landroidx/media3/exoplayer/source/ShuffleOrder;)V
...
.method public getChildIndexByPeriodIndex(I)I
    ...
    invoke-static {v0, v0, p1, p0}, Lb17;->e(ZZI[I)I
...
.method public getChildTimelines()Ljava/util/List;
    ...
    iget-object p0, p0, Landroidx/media3/exoplayer/PlaylistTimeline;->timelines:[Lip6;
...
.method public getTimelineByChildIndex(I)Lip6;
    .locals 0
