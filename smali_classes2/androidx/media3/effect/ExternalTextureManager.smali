...
.field private currentFrame:Lm92;
...
.field private lastRegisteredFrame:Lm92;
...
.method public constructor <init>(Lle2;Landroidx/media3/effect/VideoFrameProcessingTaskExecutor;ZZ)V
    .locals 0
    ...
    iput-object p1, p0, Landroidx/media3/effect/ExternalTextureManager;->glObjectsProvider:Lle2;
    ...
    invoke-static {p3, p1, p4}, Lmx2;->F(III)V
    ...
    invoke-direct {p1, p4}, Ly07;-><init>(Ljava/lang/String;)V
    ...
    iput-object p0, p1, Landroidx/media3/effect/y;->c:Landroidx/media3/effect/ExternalTextureManager;

    iput-object p2, p1, Landroidx/media3/effect/y;->f:Landroidx/media3/effect/VideoFrameProcessingTaskExecutor;
...
.method public static synthetic a(Landroidx/media3/effect/ExternalTextureManager;)V
    ...
    invoke-direct {p0}, Landroidx/media3/effect/ExternalTextureManager;->lambda$restartForceSignalEndOfStreamTimer$7()V

    return-void
.end method

.method public static synthetic b(Landroidx/media3/effect/ExternalTextureManager;)V
    .locals 0

    invoke-direct {p0}, Landroidx/media3/effect/ExternalTextureManager;->lambda$releaseAllRegisteredFrames$6()V

    return-void
.end method

.method public static synthetic c(Landroidx/media3/effect/ExternalTextureManager;Landroidx/media3/effect/VideoFrameProcessingTaskExecutor;Landroid/graphics/SurfaceTexture;)V
    .locals 0
...
.method public static synthetic f(Landroidx/media3/effect/ExternalTextureManager;Landroidx/media3/effect/ExternalShaderProgram;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/media3/effect/ExternalTextureManager;->lambda$onReadyToAcceptInputFrame$2(Landroidx/media3/effect/ExternalShaderProgram;)V
...
.method private forceSignalEndOfStream()V
    ...
    iget v3, p0, Landroidx/media3/effect/ExternalTextureManager;->availableFrameCount:I
    ...
    iput-object v0, p0, Landroidx/media3/effect/ExternalTextureManager;->currentFrame:Lm92;
...
.method public static synthetic i(Landroidx/media3/effect/ExternalTextureManager;)V
    .locals 0
...
.method private lambda$new$0()V
    ...
    iget-object v1, p0, Landroidx/media3/effect/ExternalTextureManager;->lastRegisteredFrame:Lm92;
...
.method private synthetic lambda$new$1(Landroidx/media3/effect/VideoFrameProcessingTaskExecutor;Landroid/graphics/SurfaceTexture;)V
    ...
    new-instance p2, Landroidx/media3/effect/x;

    const/4 v0, 0x5

    invoke-direct {p2, v0}, Landroidx/media3/effect/x;-><init>(I)V

    iput-object p0, p2, Landroidx/media3/effect/x;->b:Landroidx/media3/effect/ExternalTextureManager;
...
.method private lambda$onInputFrameProcessed$3()V
    .locals 4
...
.method private synthetic lambda$onReadyToAcceptInputFrame$2(Landroidx/media3/effect/ExternalShaderProgram;)V
    .locals 1
...
.method private synthetic lambda$releaseAllRegisteredFrames$6()V
    .locals 3
...
.method private synthetic lambda$restartForceSignalEndOfStreamTimer$7()V
    .locals 3
    ...
    invoke-direct {v1, v2}, Landroidx/media3/effect/x;-><init>(I)V

    iput-object p0, v1, Landroidx/media3/effect/x;->b:Landroidx/media3/effect/ExternalTextureManager;
...
.method private lambda$signalEndOfCurrentInputStream$5()V
    .locals 4
    ...
    iget-object v0, p0, Landroidx/media3/effect/ExternalTextureManager;->currentFrame:Lm92;
...
.method private maybeQueueFrameToExternalShaderProgram()V
    ...
    iget-wide v3, v0, Lm92;->b:J

    iget-object v0, v0, Lm92;->a:Lx62;
    ...
    iget-object v4, p0, Landroidx/media3/effect/ExternalTextureManager;->glObjectsProvider:Lle2;
    ...
    invoke-direct {v5, v6, v8, v7, v0}, Lre2;-><init>(IIII)V

    invoke-interface {v3, v4, v5, v1, v2}, Landroidx/media3/effect/GlShaderProgram;->queueInputFrame(Lle2;Lre2;J)V
...
.method public flush()V
    ...
    iput-object v0, p0, Landroidx/media3/effect/ExternalTextureManager;->lastRegisteredFrame:Lm92;
...
.method public onInputFrameProcessed(Lre2;)V
    ...
    invoke-direct {v0, v1}, Landroidx/media3/effect/x;-><init>(I)V

    iput-object p0, v0, Landroidx/media3/effect/x;->b:Landroidx/media3/effect/ExternalTextureManager;
...
.method public onReadyToAcceptInputFrame()V
    ...
    invoke-direct {v2, v3}, Landroidx/media3/effect/h;-><init>(I)V

    iput-object p0, v2, Landroidx/media3/effect/h;->b:Ljava/lang/Object;

    iput-object v0, v2, Landroidx/media3/effect/h;->c:Ljava/lang/Object;
...
.method public registerInputFrame(Lm92;)V
    ...
    iput-object p1, p0, Landroidx/media3/effect/ExternalTextureManager;->lastRegisteredFrame:Lm92;
...
.method public releaseAllRegisteredFrames()V
    ...
    invoke-direct {v3, v4}, Landroidx/media3/effect/x;-><init>(I)V

    iput-object p0, v3, Landroidx/media3/effect/x;->b:Landroidx/media3/effect/ExternalTextureManager;
