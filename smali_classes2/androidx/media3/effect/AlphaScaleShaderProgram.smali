...
.method public constructor <init>(Landroid/content/Context;ZF)V
    ...
    invoke-direct {p2, p1, v0, v1}, Loe2;-><init>(Landroid/content/Context;II)V

    iput-object p2, p0, Landroidx/media3/effect/AlphaScaleShaderProgram;->glProgram:Loe2;
    :try_end_0
    ...
    const-string p0, "uAlphaScale"

    invoke-virtual {p2, p0, p3}, Loe2;->f(Ljava/lang/String;F)V
...
.method public drawFrame(IJ)V
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/media3/effect/AlphaScaleShaderProgram;->glProgram:Loe2;
    ...
    iget-object p0, p0, Landroidx/media3/effect/AlphaScaleShaderProgram;->glProgram:Loe2;
