...
.method public synthetic constructor <init>(Landroidx/media3/effect/GlShaderProgramFrameProcessor;Landroidx/media3/effect/GlShaderProgramFrameProcessor$1;)V
    .locals 0
...
.method public static synthetic a(Landroidx/media3/effect/GlShaderProgramFrameProcessor$InputConsumer;Landroidx/media3/effect/GlTextureFrame;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/media3/effect/GlShaderProgramFrameProcessor$InputConsumer;->lambda$queueFrame$0(Landroidx/media3/effect/GlTextureFrame;)Ljava/lang/Object;
...
.method public static synthetic access$100(Landroidx/media3/effect/GlShaderProgramFrameProcessor$InputConsumer;)V
    .locals 0
...
.method private synthetic lambda$queueFrame$0(Landroidx/media3/effect/GlTextureFrame;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Landroidx/media3/effect/GlShaderProgramFrameProcessor;->access$700(Landroidx/media3/effect/GlShaderProgramFrameProcessor;)Lle2;

    move-result-object p0

    iget-wide v2, p1, Landroidx/media3/effect/GlTextureFrame;->presentationTimeUs:J

    invoke-interface {v1, p0, v0, v2, v3}, Landroidx/media3/effect/GlShaderProgram;->queueInputFrame(Lle2;Lre2;J)V
...
.method public queueFrame(Landroidx/media3/effect/GlTextureFrame;)Z
    ...
    invoke-static {v0}, Landroidx/media3/effect/GlShaderProgramFrameProcessor;->access$400(Landroidx/media3/effect/GlShaderProgramFrameProcessor;)Lzp3;

    move-result-object v0

    new-instance v3, Landroidx/media3/effect/c0;

    invoke-direct {v3, v2}, Landroidx/media3/effect/c0;-><init>(I)V

    iput-object p0, v3, Landroidx/media3/effect/c0;->i:Landroidx/media3/effect/FrameConsumer;

    iput-object p1, v3, Landroidx/media3/effect/c0;->f:Landroidx/media3/effect/GlTextureFrame;

    invoke-static {}, Ljava/lang/invoke/VarHandle;->storeStoreFence()V

    check-cast v0, Ll1;

    invoke-virtual {v0, v3}, Ll1;->c(Ljava/util/concurrent/Callable;)Llp3;
    ...
    invoke-static {p0}, Landroidx/media3/effect/GlShaderProgramFrameProcessor;->access$400(Landroidx/media3/effect/GlShaderProgramFrameProcessor;)Lzp3;
