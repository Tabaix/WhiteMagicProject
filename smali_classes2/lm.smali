...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Llm;->v:Landroid/content/res/AssetManager;
...
.method public final close()V
    ...
    iput-object v0, p0, Llm;->w:Landroid/net/Uri;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Llm;->x:Ljava/io/InputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Llm;->x:Ljava/io/InputStream;

    iget-boolean v0, p0, Llm;->z:Z

    if-eqz v0, :cond_1

    iput-boolean v1, p0, Llm;->z:Z
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Llm;->w:Landroid/net/Uri;
...
.method public final open(Ly61;)J
    ...
    iget-object v3, p0, Llm;->v:Landroid/content/res/AssetManager;
    ...
    iput-wide v0, p0, Llm;->y:J

    goto :goto_1

    :cond_2
    iget-object v0, p0, Llm;->x:Ljava/io/InputStream;
    ...
    :cond_3
    :goto_1
    iput-boolean v4, p0, Llm;->z:Z

    invoke-virtual {p0, p1}, Lbv;->o(Ly61;)V

    iget-wide p0, p0, Llm;->y:J
