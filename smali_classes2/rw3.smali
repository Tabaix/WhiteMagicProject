...
.method public final isSupported(Ljava/lang/Class;)Z
    ...
    invoke-interface {v3, p1}, Ls74;->isSupported(Ljava/lang/Class;)Z
...
.method public final messageInfoFor(Ljava/lang/Class;)Ls85;
    ...
    invoke-interface {v2, p1}, Ls74;->isSupported(Ljava/lang/Class;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2, p1}, Ls74;->messageInfoFor(Ljava/lang/Class;)Ls85;
