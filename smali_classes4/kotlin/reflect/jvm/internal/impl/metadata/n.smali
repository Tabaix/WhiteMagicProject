...
.field public y:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter$Variance;
...
.method public final bridge synthetic a(Lkotlin/reflect/jvm/internal/impl/protobuf/GeneratedMessageLite;)Lpd2;
    ...
    invoke-virtual {p0, p1}, Lkotlin/reflect/jvm/internal/impl/metadata/n;->e(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;)V
...
.method public final build()Lu74;
    ...
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/metadata/n;->c()Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;
...
.method public final c()Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;
    ...
    invoke-direct {v0, p0, v1}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;-><init>(Lkotlin/reflect/jvm/internal/impl/protobuf/a;Lk65;)V

    iget v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->n:I
    ...
    :goto_0
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->v:I
    ...
    :cond_1
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->w:I
    ...
    :cond_2
    iget-boolean v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->x:Z
    ...
    :cond_3
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->y:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter$Variance;
    ...
    iput v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->n:I
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;
    ...
    :cond_6
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;
...
.method public final clone()Ljava/lang/Object;
    ...
    iput-object v1, v0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->y:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter$Variance;

    sget-object v1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v1, v0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->z:Ljava/util/List;

    iput-object v1, v0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;

    iput-object v1, v0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;

    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/metadata/n;->c()Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;

    move-result-object p0

    invoke-virtual {v0, p0}, Lkotlin/reflect/jvm/internal/impl/metadata/n;->e(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;)V
...
.method public final d(Lir0;Lsw1;)Lt74;
    ...
    :try_start_0
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;->PARSER:Lmu4;
    ...
    invoke-virtual {p0, v0}, Lkotlin/reflect/jvm/internal/impl/metadata/n;->e(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;)V
...
.method public final e(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;)V
    ...
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->v:I
    ...
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->w:I
    ...
    iput-boolean v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->x:Z
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->y:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter$Variance;
    ...
    iget v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->n:I

    and-int/lit8 v0, v0, -0x11

    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->n:I
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;
    ...
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->A:Ljava/util/List;
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;
    ...
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/n;->B:Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;->access$8700(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeParameter;)Lra0;
