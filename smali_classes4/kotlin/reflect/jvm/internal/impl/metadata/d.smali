...
# instance fields
.field public A:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
...
.field public i:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value$Type;
...
.method public final b()Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;
    ...
    invoke-direct {v0, p0, v1}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;-><init>(Lpd2;Lk65;)V

    iget v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I
    ...
    :goto_0
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->i:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value$Type;
    ...
    :cond_1
    iget-wide v4, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->n:J
    ...
    :cond_2
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->v:F
    ...
    :cond_3
    iget-wide v4, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->w:D
    ...
    :cond_6
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->z:I
    ...
    :cond_7
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->A:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
    ...
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I
    ...
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->B:Ljava/util/List;

    invoke-static {v2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v2

    iput-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->B:Ljava/util/List;

    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I

    and-int/lit16 v2, v2, -0x101

    iput v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I
    ...
    :cond_9
    iget v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->C:I
...
.method public final c(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;)V
    ...
    iput v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I

    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->i:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value$Type;
    ...
    iput-wide v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->n:J
    ...
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->v:F
    ...
    iput-wide v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->w:D
    ...
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->z:I
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->A:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
    ...
    invoke-static {v1}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;->newBuilder(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;)Lkotlin/reflect/jvm/internal/impl/metadata/e;

    move-result-object v1

    invoke-virtual {v1, v0}, Lkotlin/reflect/jvm/internal/impl/metadata/e;->c(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;)V

    invoke-virtual {v1}, Lkotlin/reflect/jvm/internal/impl/metadata/e;->b()Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;

    move-result-object v0

    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->A:Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
    ...
    :goto_0
    iget v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I

    or-int/2addr v0, v2

    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->f:I
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->B:Ljava/util/List;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->B:Ljava/util/List;
    ...
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/d;->C:I
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;->access$3500(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;)Lra0;
...
.method public final d(Lir0;Lsw1;)Lt74;
    ...
    :try_start_0
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;->PARSER:Lmu4;
