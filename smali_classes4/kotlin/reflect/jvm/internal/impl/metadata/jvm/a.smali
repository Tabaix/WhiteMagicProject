...
.method public final b()Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;
    ...
    invoke-direct {v0, p0, v1}, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;-><init>(Lpd2;Lc63;)V

    iget v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->f:I
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->i:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->i:Ljava/util/List;

    iget v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->f:I

    and-int/lit8 v1, v1, -0x2

    iput v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->f:I
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;
    ...
    :cond_1
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;
...
.method public final c(Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;)V
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->i:Ljava/util/List;

    iget v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->f:I

    and-int/lit8 v0, v0, -0x2

    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->f:I
    ...
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->i:Ljava/util/List;
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;
    ...
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/a;->n:Ljava/util/List;
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;->access$1600(Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;)Lra0;
...
.method public final d(Lir0;Lsw1;)Lt74;
    ...
    :try_start_0
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/metadata/jvm/JvmProtoBuf$StringTableTypes;->PARSER:Lmu4;
