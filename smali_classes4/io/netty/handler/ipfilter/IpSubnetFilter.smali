...
.field private final ipv4Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;

.field private final ipv6Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
...
.method public constructor <init>(ZLjava/util/List;)V
    ...
    iput-object v1, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipFilterRuleTypeIPv6:Lio/netty/handler/ipfilter/IpFilterRuleType;
    ...
    :cond_8
    invoke-static {p1}, Lio/netty/handler/ipfilter/IpSubnetFilter;->sortAndFilter(Ljava/util/List;)[Lio/netty/handler/ipfilter/IpSubnetFilterRule;

    move-result-object p1

    :goto_3
    iput-object p1, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv4Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
    ...
    :cond_9
    invoke-static {v0}, Lio/netty/handler/ipfilter/IpSubnetFilter;->sortAndFilter(Ljava/util/List;)[Lio/netty/handler/ipfilter/IpSubnetFilterRule;

    move-result-object p2

    :goto_4
    iput-object p2, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv6Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
...
.method public varargs constructor <init>(Z[Lio/netty/handler/ipfilter/IpSubnetFilterRule;)V
    ...
    check-cast p2, [Lio/netty/handler/ipfilter/IpSubnetFilterRule;
...
.method private static sortAndFilter(Ljava/util/List;)[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-array p0, p0, [Lio/netty/handler/ipfilter/IpSubnetFilterRule;
...
.method public accept(Lio/netty/channel/ChannelHandlerContext;Ljava/net/InetSocketAddress;)Z
    ...
    iget-object p1, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv4Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
    ...
    invoke-static {p1, p2, v2}, Ljava/util/Arrays;->binarySearch([Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Comparator;)I
    ...
    iget-object p0, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv4Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
    ...
    :cond_3
    iget-object p1, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv6Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
    ...
    iget-object p0, p0, Lio/netty/handler/ipfilter/IpSubnetFilter;->ipv6Rules:[Lio/netty/handler/ipfilter/IpSubnetFilterRule;
