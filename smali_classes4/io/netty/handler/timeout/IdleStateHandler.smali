...
.field private ticker:Lio/netty/util/concurrent/Ticker;
...
.method public constructor <init>(ZJJJLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object v0, p0, Lio/netty/handler/timeout/IdleStateHandler;->ticker:Lio/netty/util/concurrent/Ticker;
    ...
    invoke-direct {v1, v0}, Lwq1;-><init>(I)V

    iput-object p0, v1, Lwq1;->f:Ljava/lang/Object;

    invoke-static {}, Ljava/lang/invoke/VarHandle;->storeStoreFence()V

    iput-object v1, p0, Lio/netty/handler/timeout/IdleStateHandler;->writeListener:Lio/netty/channel/ChannelFutureListener;
...
.method public static synthetic access$1300(Lio/netty/handler/timeout/IdleStateHandler;)Z
    .locals 0
...
.method public static synthetic access$1302(Lio/netty/handler/timeout/IdleStateHandler;Z)Z
    .locals 0
...
.method public static synthetic access$200(Lio/netty/handler/timeout/IdleStateHandler;)Lio/netty/util/concurrent/Ticker;
    .locals 0

    iget-object p0, p0, Lio/netty/handler/timeout/IdleStateHandler;->ticker:Lio/netty/util/concurrent/Ticker;
...
.method public static synthetic access$402(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/util/concurrent/Future;)Lio/netty/util/concurrent/Future;
    .locals 0
...
.method public static synthetic access$500(Lio/netty/handler/timeout/IdleStateHandler;)Z
    .locals 0
...
.method public static synthetic access$502(Lio/netty/handler/timeout/IdleStateHandler;Z)Z
    .locals 0
...
.method public static synthetic access$700(Lio/netty/handler/timeout/IdleStateHandler;)J
    .locals 2
...
.method public static synthetic access$802(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/util/concurrent/Future;)Lio/netty/util/concurrent/Future;
    .locals 0
...
.method public static synthetic access$900(Lio/netty/handler/timeout/IdleStateHandler;)Z
    .locals 0
...
.method public static synthetic access$902(Lio/netty/handler/timeout/IdleStateHandler;Z)Z
    .locals 0
...
.method public static synthetic c(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/channel/ChannelFuture;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/handler/timeout/IdleStateHandler;->lambda$new$0(Lio/netty/channel/ChannelFuture;)V
...
.method private initialize(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    iget-object v0, p0, Lio/netty/handler/timeout/IdleStateHandler;->ticker:Lio/netty/util/concurrent/Ticker;
    ...
    iput-object p0, v4, Lio/netty/handler/timeout/IdleStateHandler;->readerIdleTimeout:Lio/netty/util/concurrent/Future;
    ...
    :goto_0
    iget-wide p0, v4, Lio/netty/handler/timeout/IdleStateHandler;->writerIdleTimeNanos:J
    ...
    invoke-direct {v6, v4, v5}, Lio/netty/handler/timeout/IdleStateHandler$WriterIdleTimeoutTask;-><init>(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/channel/ChannelHandlerContext;)V
    ...
    iput-object p0, v4, Lio/netty/handler/timeout/IdleStateHandler;->writerIdleTimeout:Lio/netty/util/concurrent/Future;

    :cond_1
    iget-wide p0, v4, Lio/netty/handler/timeout/IdleStateHandler;->allIdleTimeNanos:J
    ...
    invoke-direct {v6, v4, v5}, Lio/netty/handler/timeout/IdleStateHandler$AllIdleTimeoutTask;-><init>(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/channel/ChannelHandlerContext;)V
    ...
    iput-object p0, v4, Lio/netty/handler/timeout/IdleStateHandler;->allIdleTimeout:Lio/netty/util/concurrent/Future;
...
.method private synthetic lambda$new$0(Lio/netty/channel/ChannelFuture;)V
    ...
    iget-object p1, p0, Lio/netty/handler/timeout/IdleStateHandler;->ticker:Lio/netty/util/concurrent/Ticker;
...
.method public handlerAdded(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-interface {v0}, Lio/netty/util/concurrent/EventExecutorGroup;->ticker()Lio/netty/util/concurrent/Ticker;
...
.method public newIdleStateEvent(Lio/netty/handler/timeout/IdleState;Z)Lio/netty/handler/timeout/IdleStateEvent;
    ...
    sget-object p0, Lio/netty/handler/timeout/IdleStateHandler$1;->$SwitchMap$io$netty$handler$timeout$IdleState:[I
