...
# instance fields
.field protected final delegate:Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;
...
.field protected final spdyVersion:I
...
.method public decode(Lio/netty/buffer/ByteBuf;)V
    ...
    iget-object p0, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->state:Lio/netty/handler/codec/spdy/SpdyFrameDecoder$State;
    ...
    invoke-virtual {p1, v0}, Lio/netty/buffer/ByteBuf;->readRetainedSlice(I)Lio/netty/buffer/ByteBuf;
    ...
    :pswitch_3
    iget v0, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->frameType:I

    iget-byte v1, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->flags:B

    iget v2, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->length:I

    invoke-virtual {p0, v0, v1, v2, p1}, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->decodeUnknownFrame(IBILio/netty/buffer/ByteBuf;)Z
    ...
    iput v0, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->frameType:I
    ...
    iput v2, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->frameType:I
    ...
    iget v2, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->frameType:I
    ...
    iget v1, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->frameType:I

    iget-byte v2, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->flags:B

    iget v3, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->length:I

    invoke-virtual {p0, v0, v1, v2, v3}, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->isValidUnknownFrameHeader(IIBI)Z

    move-result v0

    if-eqz v0, :cond_1d

    sget-object v0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder$State;->READ_UNKNOWN_FRAME:Lio/netty/handler/codec/spdy/SpdyFrameDecoder$State;
    ...
    invoke-static {v0, v1}, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->getNextState(II)Lio/netty/handler/codec/spdy/SpdyFrameDecoder$State;
...
.method public decodeUnknownFrame(IBILio/netty/buffer/ByteBuf;)Z
    .locals 2
    ...
    iget-object p0, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->delegate:Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;

    sget-object p3, Lio/netty/buffer/Unpooled;->EMPTY_BUFFER:Lio/netty/buffer/ByteBuf;

    invoke-interface {p0, p1, p2, p3}, Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;->readUnknownFrame(IBLio/netty/buffer/ByteBuf;)V
    ...
    :cond_1
    invoke-virtual {p4, p3}, Lio/netty/buffer/ByteBuf;->readRetainedSlice(I)Lio/netty/buffer/ByteBuf;
