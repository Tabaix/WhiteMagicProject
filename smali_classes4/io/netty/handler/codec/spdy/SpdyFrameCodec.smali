...
# static fields
.field protected static final INVALID_FRAME:Lio/netty/handler/codec/spdy/SpdyProtocolException;
...
.field protected final spdyFrameDecoder:Lio/netty/handler/codec/spdy/SpdyFrameDecoder;

.field protected final spdyFrameEncoder:Lio/netty/handler/codec/spdy/SpdyFrameEncoder;
...
.field private final supportsUnknownFrames:Z
...
.method public constructor <init>(Lio/netty/handler/codec/spdy/SpdyVersion;IIIIIZ)V
    ...
    .line 28
    invoke-direct/range {p0 .. p6}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;-><init>(Lio/netty/handler/codec/spdy/SpdyVersion;ILio/netty/handler/codec/spdy/SpdyHeaderBlockDecoder;Lio/netty/handler/codec/spdy/SpdyHeaderBlockEncoder;ZZ)V

    return-void
.end method

.method public constructor <init>(Lio/netty/handler/codec/spdy/SpdyVersion;IIIIIZZ)V
    .locals 0
...
.method public constructor <init>(Lio/netty/handler/codec/spdy/SpdyVersion;ILio/netty/handler/codec/spdy/SpdyHeaderBlockDecoder;Lio/netty/handler/codec/spdy/SpdyHeaderBlockEncoder;Z)V
    ...
    .line 32
    invoke-direct/range {v0 .. v6}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;-><init>(Lio/netty/handler/codec/spdy/SpdyVersion;ILio/netty/handler/codec/spdy/SpdyHeaderBlockDecoder;Lio/netty/handler/codec/spdy/SpdyHeaderBlockEncoder;ZZ)V

    return-void
.end method

.method public constructor <init>(Lio/netty/handler/codec/spdy/SpdyVersion;ILio/netty/handler/codec/spdy/SpdyHeaderBlockDecoder;Lio/netty/handler/codec/spdy/SpdyHeaderBlockEncoder;ZZ)V
    .locals 0

    invoke-direct {p0}, Lio/netty/handler/codec/ByteToMessageDecoder;-><init>()V

    iput-boolean p6, p0, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->supportsUnknownFrames:Z

    invoke-virtual {p0, p1, p0, p2}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->createDecoder(Lio/netty/handler/codec/spdy/SpdyVersion;Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;I)Lio/netty/handler/codec/spdy/SpdyFrameDecoder;

    move-result-object p2

    iput-object p2, p0, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->spdyFrameDecoder:Lio/netty/handler/codec/spdy/SpdyFrameDecoder;

    invoke-virtual {p0, p1}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->createEncoder(Lio/netty/handler/codec/spdy/SpdyVersion;)Lio/netty/handler/codec/spdy/SpdyFrameEncoder;

    move-result-object p1

    iput-object p1, p0, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->spdyFrameEncoder:Lio/netty/handler/codec/spdy/SpdyFrameEncoder;
...
.method public static synthetic access$000(Lio/netty/handler/codec/spdy/SpdyFrameCodec;)Z
    .locals 0

    iget-boolean p0, p0, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->supportsUnknownFrames:Z

    return p0
.end method

.method public static synthetic c(Lio/netty/handler/codec/spdy/SpdyFrameCodec;Lio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->lambda$handlerAdded$0(Lio/netty/util/concurrent/Future;)V

    return-void
.end method

.method private synthetic lambda$handlerAdded$0(Lio/netty/util/concurrent/Future;)V
    .locals 0

    iget-object p1, p0, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->spdyHeaderBlockDecoder:Lio/netty/handler/codec/spdy/SpdyHeaderBlockDecoder;
...
.method public createDecoder(Lio/netty/handler/codec/spdy/SpdyVersion;Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;I)Lio/netty/handler/codec/spdy/SpdyFrameDecoder;
    .locals 1

    new-instance v0, Lio/netty/handler/codec/spdy/SpdyFrameCodec$1;

    invoke-direct {v0, p0, p1, p2, p3}, Lio/netty/handler/codec/spdy/SpdyFrameCodec$1;-><init>(Lio/netty/handler/codec/spdy/SpdyFrameCodec;Lio/netty/handler/codec/spdy/SpdyVersion;Lio/netty/handler/codec/spdy/SpdyFrameDecoderDelegate;I)V

    return-object v0
.end method

.method public createEncoder(Lio/netty/handler/codec/spdy/SpdyVersion;)Lio/netty/handler/codec/spdy/SpdyFrameEncoder;
    .locals 0

    new-instance p0, Lio/netty/handler/codec/spdy/SpdyFrameEncoder;

    invoke-direct {p0, p1}, Lio/netty/handler/codec/spdy/SpdyFrameEncoder;-><init>(Lio/netty/handler/codec/spdy/SpdyVersion;)V
...
.method public newSpdyUnknownFrame(IBLio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/spdy/SpdyFrame;
    .locals 0

    new-instance p0, Lio/netty/handler/codec/spdy/DefaultSpdyUnknownFrame;

    invoke-direct {p0, p1, p2, p3}, Lio/netty/handler/codec/spdy/DefaultSpdyUnknownFrame;-><init>(IBLio/netty/buffer/ByteBuf;)V
...
.method public readUnknownFrame(IBLio/netty/buffer/ByteBuf;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/netty/handler/codec/spdy/SpdyFrameCodec;->newSpdyUnknownFrame(IBLio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/spdy/SpdyFrame;
...
.method public write(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)V
    ...
    invoke-virtual {p0, v0, v2, p2, v1}, Lio/netty/handler/codec/spdy/SpdyFrameEncoder;->encodeSynReplyFrame(Lio/netty/buffer/ByteBufAllocator;IZLio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;
    ...
    invoke-virtual {p0, v0, v2, p2, v1}, Lio/netty/handler/codec/spdy/SpdyFrameEncoder;->encodeHeadersFrame(Lio/netty/buffer/ByteBufAllocator;IZLio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;
    ...
    :cond_8
    instance-of v0, p2, Lio/netty/handler/codec/spdy/SpdyUnknownFrame;

    if-eqz v0, :cond_9

    check-cast p2, Lio/netty/handler/codec/spdy/SpdyUnknownFrame;
    ...
    invoke-interface {p2}, Lio/netty/handler/codec/spdy/SpdyUnknownFrame;->frameType()I

    move-result v1

    invoke-interface {p2}, Lio/netty/handler/codec/spdy/SpdyUnknownFrame;->flags()B
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lio/netty/handler/codec/spdy/SpdyFrameEncoder;->encodeUnknownFrame(Lio/netty/buffer/ByteBufAllocator;IBLio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;
