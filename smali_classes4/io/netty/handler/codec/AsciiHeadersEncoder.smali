...
.method public encode(Ljava/util/Map$Entry;)V
    ...
    :cond_0
    const-string p1, "Unexpected separator type: "

    iget-object p0, p0, Lio/netty/handler/codec/AsciiHeadersEncoder;->separatorType:Lio/netty/handler/codec/AsciiHeadersEncoder$SeparatorType;
    ...
    invoke-virtual {v1, p0, v0}, Lio/netty/buffer/ByteBuf;->setByte(II)Lio/netty/buffer/ByteBuf;

    goto :goto_1

    :cond_2
    const-string p1, "Unexpected newline type: "
