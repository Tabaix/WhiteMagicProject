...
.field private consumeContent:Z
...
.method public constructor <init>(Lio/netty/handler/codec/http/cors/CorsConfig;)V
    ...
    check-cast v0, Lio/netty/handler/codec/http/cors/CorsConfig;
...
.method private getForOrigin(Ljava/lang/String;)Lio/netty/handler/codec/http/cors/CorsConfig;
    ...
    iget-object p0, p0, Lio/netty/handler/codec/http/cors/CorsHandler;->configList:Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {v0}, Lio/netty/handler/codec/http/cors/CorsConfig;->isNullOriginAllowed()Z
...
.method private handlePreflight(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpRequest;)V
    ...
    invoke-virtual {v4, v5}, Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;->withCombiningHeaders(Z)Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;
    ...
    invoke-virtual {v6, v5}, Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;->withCombiningHeaders(Z)Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;
    ...
    invoke-virtual {p0, v1, v2}, Lio/netty/handler/codec/http/HttpHeaders;->set(Ljava/lang/CharSequence;Ljava/lang/Object;)Lio/netty/handler/codec/http/HttpHeaders;
...
.method private setAllowPrivateNetwork(Lio/netty/handler/codec/http/HttpResponse;)V
    ...
    invoke-virtual {p0}, Lio/netty/handler/codec/http/cors/CorsConfig;->isPrivateNetworkAllowed()Z
    ...
    sget-object p1, Lio/netty/handler/codec/http/HttpHeaderNames;->ACCESS_CONTROL_ALLOW_PRIVATE_NETWORK:Lio/netty/util/AsciiString;
...
.method private setOrigin(Lio/netty/handler/codec/http/HttpResponse;)Z
    ...
    iget-object v3, p0, Lio/netty/handler/codec/http/cors/CorsHandler;->config:Lio/netty/handler/codec/http/cors/CorsConfig;

    if-eqz v1, :cond_2

    invoke-virtual {v3}, Lio/netty/handler/codec/http/cors/CorsConfig;->isCredentialsAllowed()Z
    ...
    :cond_2
    invoke-virtual {v3}, Lio/netty/handler/codec/http/cors/CorsConfig;->origins()Ljava/util/Set;
...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    iput-boolean v2, p0, Lio/netty/handler/codec/http/cors/CorsHandler;->consumeContent:Z
    ...
    iput-boolean v0, p0, Lio/netty/handler/codec/http/cors/CorsHandler;->consumeContent:Z
    ...
    :cond_2
    iget-boolean p0, p0, Lio/netty/handler/codec/http/cors/CorsHandler;->consumeContent:Z
