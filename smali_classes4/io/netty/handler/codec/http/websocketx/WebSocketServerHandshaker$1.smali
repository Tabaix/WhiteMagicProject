...
.method public constructor <init>(Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker;Lio/netty/channel/ChannelPromise;Lio/netty/channel/Channel;Lio/netty/handler/codec/http/HttpHeaders;)V
    ...
    iput-object p2, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->val$promise:Lio/netty/channel/ChannelPromise;

    iput-object p3, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->val$channel:Lio/netty/channel/Channel;

    iput-object p4, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->val$responseHeaders:Lio/netty/handler/codec/http/HttpHeaders;
...
.method private handleHandshakeRequest(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;)V
    ...
    iget-object p1, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->this$0:Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker;

    iget-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->val$channel:Lio/netty/channel/Channel;

    check-cast p2, Lio/netty/handler/codec/http/FullHttpRequest;

    iget-object v1, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->val$responseHeaders:Lio/netty/handler/codec/http/HttpHeaders;
    ...
    iget-object p2, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->fullHttpRequest:Lio/netty/handler/codec/http/FullHttpRequest;

    const/4 v0, 0x0

    iput-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->fullHttpRequest:Lio/netty/handler/codec/http/FullHttpRequest;
    ...
    iget-object p0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->fullHttpRequest:Lio/netty/handler/codec/http/FullHttpRequest;
...
.method private releaseFullHttpRequest()V
    ...
    iget-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->fullHttpRequest:Lio/netty/handler/codec/http/FullHttpRequest;
...
.method public channelInactive(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-direct {p0}, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->releaseFullHttpRequest()V
...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker$1;->handleHandshakeRequest(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
