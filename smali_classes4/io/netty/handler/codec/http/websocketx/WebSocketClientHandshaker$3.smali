...
.method public constructor <init>(Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker;Lio/netty/channel/ChannelPromise;Lio/netty/channel/Channel;)V
    ...
    iput-object p2, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$promise:Lio/netty/channel/ChannelPromise;

    iput-object p3, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$channel:Lio/netty/channel/Channel;
...
.method private handleHandshakeResponse(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;)V
    ...
    invoke-direct {p0, p2}, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->tryFinishHandshake(Lio/netty/handler/codec/http/FullHttpResponse;)V
    ...
    iget-object p2, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->fullHttpResponse:Lio/netty/handler/codec/http/FullHttpResponse;

    const/4 v0, 0x0

    iput-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->fullHttpResponse:Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    iget-object p0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->fullHttpResponse:Lio/netty/handler/codec/http/FullHttpResponse;
...
.method private releaseFullHttpResponse()V
    ...
    iget-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->fullHttpResponse:Lio/netty/handler/codec/http/FullHttpResponse;
...
.method private tryFinishHandshake(Lio/netty/handler/codec/http/FullHttpResponse;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->this$0:Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker;

    iget-object v1, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$channel:Lio/netty/channel/Channel;
    ...
    iget-object p1, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$promise:Lio/netty/channel/ChannelPromise;
    ...
    iget-object p0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$promise:Lio/netty/channel/ChannelPromise;
...
.method public channelInactive(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->val$promise:Lio/netty/channel/ChannelPromise;
    ...
    invoke-direct {p0}, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->releaseFullHttpResponse()V
...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker$3;->handleHandshakeResponse(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
