...
.field private final validateRequestLine:Z
...
.method public constructor <init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpMethod;Ljava/lang/String;Lio/netty/handler/codec/http/HttpHeaders;Z)V
    .locals 0
    ...
    iput-boolean p5, p0, Lio/netty/handler/codec/http/DefaultHttpRequest;->validateRequestLine:Z

    if-eqz p5, :cond_0

    invoke-static {p2, p3}, Lio/netty/handler/codec/http/HttpUtil;->validateRequestLineTokens(Lio/netty/handler/codec/http/HttpMethod;Ljava/lang/String;)V
...
.method public setMethod(Lio/netty/handler/codec/http/HttpMethod;)Lio/netty/handler/codec/http/HttpRequest;
    ...
    iget-boolean v0, p0, Lio/netty/handler/codec/http/DefaultHttpRequest;->validateRequestLine:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lio/netty/handler/codec/http/DefaultHttpRequest;->uri:Ljava/lang/String;

    invoke-static {p1, v0}, Lio/netty/handler/codec/http/HttpUtil;->validateRequestLineTokens(Lio/netty/handler/codec/http/HttpMethod;Ljava/lang/String;)V
...
.method public setUri(Ljava/lang/String;)Lio/netty/handler/codec/http/HttpRequest;
    ...
    invoke-static {v0, p1}, Lio/netty/handler/codec/http/HttpUtil;->validateRequestLineTokens(Lio/netty/handler/codec/http/HttpMethod;Ljava/lang/String;)V
