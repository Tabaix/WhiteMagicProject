...
.method private fireExceptionCaughtForActiveStream(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/netty/handler/codec/http2/Http2MultiplexHandler$1;-><init>(Lio/netty/handler/codec/http2/Http2MultiplexHandler;Ljava/lang/Throwable;)V
...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    instance-of p0, p2, Lio/netty/handler/codec/http2/Http2WindowUpdateFrame;
    ...
    check-cast p0, Lio/netty/handler/codec/http2/Http2StreamFrame;

    invoke-interface {p0}, Lio/netty/handler/codec/http2/Http2StreamFrame;->stream()Lio/netty/handler/codec/http2/Http2FrameStream;
    ...
    :cond_1
    invoke-virtual {p1, p0}, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;->fireChildRead(Lio/netty/handler/codec/http2/Http2Frame;)V
    ...
    invoke-interface {p0, p2}, Lio/netty/channel/ChannelPipeline;->fireUserEventTriggered(Ljava/lang/Object;)Lio/netty/channel/ChannelPipeline;
...
.method public exceptionCaught(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)V
    ...
    check-cast p0, Lio/netty/handler/codec/http2/Http2FrameStreamException;

    invoke-virtual {p0}, Lio/netty/handler/codec/http2/Http2FrameStreamException;->stream()Lio/netty/handler/codec/http2/Http2FrameStream;
    ...
    invoke-virtual {p0}, Lio/netty/handler/codec/http2/Http2FrameStreamException;->error()Lio/netty/handler/codec/http2/Http2Error;

    move-result-object p0

    invoke-virtual {p1, p0}, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;->closeWithError(Lio/netty/handler/codec/http2/Http2Error;)V
...
.method public handlerAdded0(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    :cond_0
    const-string p0, "EventExecutor must be EventLoop of Channel"
...
.method public userEventTriggered(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    :cond_0
    iget-object p0, v0, Lio/netty/handler/codec/http2/Http2FrameCodec$DefaultHttp2FrameStream;->attachment:Lio/netty/channel/Channel;

    check-cast p0, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;

    if-eqz p0, :cond_7

    invoke-virtual {p0}, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;->streamClosed()V
    ...
    const-string p2, "Client is misconfigured for upgrade requests"
    ...
    invoke-static {p0}, Lio/netty/handler/codec/http2/Http2MultiplexHandler;->registerDone(Lio/netty/channel/ChannelFuture;)V

    return-void

    :cond_6
    sget-object p1, Lio/netty/handler/codec/http2/Http2MultiplexHandler;->CHILD_CHANNEL_REGISTRATION_LISTENER:Lio/netty/channel/ChannelFutureListener;
