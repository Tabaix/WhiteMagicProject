...
.method public constructor <init>(IIIIZI)V
    ...
    const-string p1, "numFastBytes: %d (expected: %d-%d)"
    ...
    invoke-static {p3, p0, v1}, Lgf2;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p0, v1}, Lgf2;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public encode(Lio/netty/channel/ChannelHandlerContext;Lio/netty/buffer/ByteBuf;Lio/netty/buffer/ByteBuf;)V
    ...
    new-instance v1, Lio/netty/buffer/ByteBufInputStream;

    invoke-direct {v1, p2}, Lio/netty/buffer/ByteBufInputStream;-><init>(Lio/netty/buffer/ByteBuf;)V

    :try_start_0
    new-instance v2, Lio/netty/buffer/ByteBufOutputStream;

    invoke-direct {v2, p3}, Lio/netty/buffer/ByteBufOutputStream;-><init>(Lio/netty/buffer/ByteBuf;)V
    :try_end_0
    ...
    invoke-virtual {v2, p2}, Lio/netty/buffer/ByteBufOutputStream;->writeByte(I)V

    iget p2, p0, Lio/netty/handler/codec/compression/LzmaFrameEncoder;->littleEndianDictionarySize:I

    invoke-virtual {v2, p2}, Lio/netty/buffer/ByteBufOutputStream;->writeInt(I)V
    ...
    invoke-virtual {v2, p1, p2}, Lio/netty/buffer/ByteBufOutputStream;->writeLong(J)V
