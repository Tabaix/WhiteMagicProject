...
.field private static final DEFAULT_USE_JDK_PROVIDERS:Z
...
.field final credentials:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field final engines:Ljava/util/concurrent/ConcurrentMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final groups:[Ljava/lang/String;

.field final hasTLSv13Cipher:Z

.field final hasTmpDhKeys:Z
...
.method static constructor <clinit>()V
    ...
    const-string v2, "io.netty.handler.ssl.useJdkProviderSignatures"
    ...
    sput-boolean v2, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->DEFAULT_USE_JDK_PROVIDERS:Z

    const-string v2, "io.netty.handler.ssl.openssl.bioNonApplicationBufferSize"

    const/16 v4, 0x800

    invoke-static {v2, v4}, Lio/netty/util/internal/SystemPropertyUtil;->getInt(Ljava/lang/String;I)I
...
.method public constructor <init>(Ljava/lang/Iterable;Lio/netty/handler/ssl/CipherSuiteFilter;Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;I[Ljava/security/cert/Certificate;Lio/netty/handler/ssl/ClientAuth;[Ljava/lang/String;ZLjava/lang/String;ZZLjava/util/List;Lio/netty/handler/ssl/ResumptionController;[Ljava/util/Map$Entry;Ljava/util/List;)V
    ...
    iput-object v5, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->engines:Ljava/util/concurrent/ConcurrentMap;
    ...
    iput-object v5, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->credentials:Ljava/util/List;
    ...
    sget-object v8, Lio/netty/handler/ssl/OpenSsl;->NAMED_GROUPS:[Ljava/lang/String;
    ...
    check-cast v5, Lio/netty/handler/ssl/SslContextOption;
    ...
    check-cast v13, Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;
    ...
    check-cast v14, Lio/netty/handler/ssl/OpenSslAsyncPrivateKeyMethod;

    goto/16 :goto_4

    :cond_7
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->CERTIFICATE_COMPRESSION_ALGORITHMS:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    check-cast v16, Lio/netty/handler/ssl/OpenSslCertificateCompressionConfig;

    goto/16 :goto_4

    :cond_8
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->MAX_CERTIFICATE_LIST_BYTES:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_9
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->TMP_DH_KEYLENGTH:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_a
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->GROUPS:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    invoke-static/range {v18 .. v18}, Lio/netty/handler/ssl/GroupsConverter;->toOpenSsl(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_c
    sget-object v3, Lio/netty/handler/ssl/OpenSslContextOption;->USE_JDK_PROVIDER_SIGNATURES:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    const-string v6, "Alternative key fallback policy set to: "
    ...
    const-string v6, "Skipping unsupported SslContextOption: "
    ...
    :cond_11
    :goto_6
    iput-boolean v12, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->tlsFalseStart:Z
    ...
    iput-object v3, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->serverNames:Ljava/util/List;
    ...
    invoke-static {v3, v4, v10, v11}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    ...
    invoke-static {v9, v10, v3, v4}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    ...
    invoke-static {v9, v10}, Lio/netty/internal/tcnative/SSLContext;->getOptions(J)I

    move-result v4

    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_SSLv2:I

    or-int/2addr v4, v9

    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_SSLv3:I
    ...
    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_TLSv1_1:I

    or-int/2addr v4, v9

    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_CIPHER_SERVER_PREFERENCE:I

    or-int/2addr v4, v9

    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_COMPRESSION:I

    or-int/2addr v4, v9

    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_TICKET:I
    ...
    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_TLSv1_2:I
    ...
    :cond_1b
    iput-boolean v3, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->hasTLSv13Cipher:Z

    iget-wide v9, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->ctx:J

    invoke-static {v9, v10, v4}, Lio/netty/internal/tcnative/SSLContext;->setOptions(JI)V
    ...
    iput-boolean v3, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->hasTmpDhKeys:Z
    ...
    sget-object v9, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$3;->$SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol:[I
    ...
    invoke-static {v9, v10, v0, v3}, Lio/netty/internal/tcnative/SSLContext;->setNpnProtos(J[Ljava/lang/String;I)V

    iget-wide v9, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->ctx:J

    invoke-static {v9, v10, v0, v3}, Lio/netty/internal/tcnative/SSLContext;->setAlpnProtos(J[Ljava/lang/String;I)V
    ...
    const-string v3, "Unexpected apn protocol: "
    ...
    iget-object v6, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->engines:Ljava/util/concurrent/ConcurrentMap;

    invoke-direct {v0, v6, v13}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$PrivateKeyMethod;-><init>(Ljava/util/Map;Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;)V
    ...
    invoke-direct {v0, v6, v14}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$AsyncPrivateKeyMethod;-><init>(Ljava/util/Map;Lio/netty/handler/ssl/OpenSslAsyncPrivateKeyMethod;)V
    ...
    invoke-virtual/range {v16 .. v16}, Lio/netty/handler/ssl/OpenSslCertificateCompressionConfig;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct {v3, v6, v7}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$CompressionAlgorithm;-><init>(Ljava/util/Map;Lio/netty/handler/ssl/OpenSslCertificateCompressionAlgorithm;)V
    ...
    invoke-static {v2, v3, v8}, Lio/netty/internal/tcnative/SSLContext;->setCurvesList(J[Ljava/lang/String;)Z
    ...
    const-string v2, "failed to set curves / groups suite: "
    ...
    :cond_2b
    iput-object v8, v1, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->groups:[Ljava/lang/String;
    ...
    check-cast v2, Lio/netty/handler/ssl/OpenSslCredential;

    invoke-direct {v1, v2}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->addCredential(Lio/netty/handler/ssl/OpenSslCredential;)V
...
.method public static synthetic access$300(Ljava/util/Map;J)Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;
    .locals 0

    invoke-static {p0, p1, p2}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->retrieveEngine(Ljava/util/Map;J)Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;
...
.method private addCredential(Lio/netty/handler/ssl/OpenSslCredential;)V
    .locals 5

    instance-of v0, p1, Lio/netty/handler/ssl/OpenSslCredentialPointer;
    ...
    :try_start_0
    iget-object v1, p0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->credentials:Ljava/util/List;
    ...
    invoke-static {v1, v2, v3, v4}, Lio/netty/internal/tcnative/SSLContext;->addCredential(JJ)V
    :try_end_0
    ...
    iget-object p0, p0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->credentials:Ljava/util/List;
    ...
    const-string p1, "Failed to add credential to SSL context"
...
.method public static certChainToKeyManagerFactory([Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljava/lang/String;)Ljavax/net/ssl/KeyManagerFactory;
    .locals 0

    invoke-static {p2}, Lio/netty/handler/ssl/SslContext;->keyStorePassword(Ljava/lang/String;)[C

    move-result-object p2

    invoke-static {p0, p1, p2, p3}, Lio/netty/handler/ssl/SslContext;->buildKeyStore([Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;[CLjava/lang/String;)Ljava/security/KeyStore;
    ...
    new-instance p1, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory;

    invoke-direct {p1}, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory;-><init>()V

    goto :goto_0

    :cond_0
    new-instance p1, Lio/netty/handler/ssl/OpenSslCachingX509KeyManagerFactory;
    ...
    invoke-direct {p1, p3}, Lio/netty/handler/ssl/OpenSslCachingX509KeyManagerFactory;-><init>(Ljavax/net/ssl/KeyManagerFactory;)V
...
.method public static chooseTrustManager([Ljavax/net/ssl/TrustManager;Lio/netty/handler/ssl/ResumptionController;)Ljavax/net/ssl/X509TrustManager;
    ...
    new-instance p1, Lio/netty/handler/ssl/EnhancingX509ExtendedTrustManager;

    invoke-direct {p1, p0}, Lio/netty/handler/ssl/EnhancingX509ExtendedTrustManager;-><init>(Ljavax/net/ssl/X509TrustManager;)V
...
.method public static varargs isJdkSignatureFallbackEnabled([Ljava/util/Map$Entry;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    sget-boolean v0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->DEFAULT_USE_JDK_PROVIDERS:Z
    ...
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->USE_JDK_PROVIDER_SIGNATURES:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_0
    sget-object v4, Lio/netty/handler/ssl/OpenSslContextOption;->PRIVATE_KEY_METHOD:Lio/netty/handler/ssl/OpenSslContextOption;

    if-eq v5, v4, :cond_2

    sget-object v4, Lio/netty/handler/ssl/OpenSslContextOption;->ASYNC_PRIVATE_KEY_METHOD:Lio/netty/handler/ssl/OpenSslContextOption;
...
.method private static opensslSelectorFailureBehavior(Lio/netty/handler/ssl/ApplicationProtocolConfig$SelectorFailureBehavior;)I
    ...
    :cond_0
    const-string v0, "Unexpected behavior: "

    invoke-static {p0, v0}, Lx74;->f(Ljava/lang/Object;Ljava/lang/String;)V
...
.method private static retrieveEngine(Ljava/util/Map;J)Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setupSecurityProviderSignatureSource(Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;J[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/util/function/Function;)Lio/netty/handler/ssl/OpenSslKeyMaterialProvider;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Lio/netty/internal/tcnative/CertificateCallback;",
            ">;)",
            "Lio/netty/handler/ssl/OpenSslKeyMaterialProvider;"
        }
    .end annotation

    new-instance v0, Lio/netty/handler/ssl/JdkDelegatingPrivateKeyMethod;

    invoke-direct {v0, p4}, Lio/netty/handler/ssl/JdkDelegatingPrivateKeyMethod;-><init>(Ljava/security/PrivateKey;)V

    invoke-static {p1, p2, v0}, Lio/netty/internal/tcnative/SSLContext;->setPrivateKeyMethod(JLio/netty/internal/tcnative/SSLPrivateKeyMethod;)V

    invoke-static {p3}, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory;->newKeyless([Ljava/security/cert/X509Certificate;)Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory;

    move-result-object p3

    const-string p4, ""

    invoke-static {p3, p4}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->providerFor(Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/String;)Lio/netty/handler/ssl/OpenSslKeyMaterialProvider;

    move-result-object p3

    :try_start_0
    new-instance p4, Lio/netty/handler/ssl/OpenSslKeyMaterialManager;

    iget-boolean p0, p0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->hasTmpDhKeys:Z

    invoke-direct {p4, p3, p0}, Lio/netty/handler/ssl/OpenSslKeyMaterialManager;-><init>(Lio/netty/handler/ssl/OpenSslKeyMaterialProvider;Z)V

    invoke-interface {p5, p4}, Ljava/util/function/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lio/netty/internal/tcnative/CertificateCallback;

    invoke-static {p1, p2, p0}, Lio/netty/internal/tcnative/SSLContext;->setCertificateCallback(JLio/netty/internal/tcnative/CertificateCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p3}, Lio/netty/handler/ssl/OpenSslKeyMaterialProvider;->destroy()V
...
.method public static toNegotiator(Lio/netty/handler/ssl/ApplicationProtocolConfig;)Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;
    ...
    invoke-static {v5, p0, v4}, Ln92;->i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public newEngine0(Lio/netty/buffer/ByteBufAllocator;Ljava/lang/String;IZ)Ljavax/net/ssl/SSLEngine;
    ...
    iget-object v8, p0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->serverNames:Ljava/util/List;
...
.method public newHandler(Lio/netty/buffer/ByteBufAllocator;Ljava/lang/String;IZLjava/util/concurrent/Executor;)Lio/netty/handler/ssl/SslHandler;
    ...
    invoke-direct {p4, p1, v0, p5, p0}, Lio/netty/handler/ssl/SslHandler;-><init>(Ljavax/net/ssl/SSLEngine;ZLjava/util/concurrent/Executor;Lio/netty/handler/ssl/ResumptionController;)V
...
.method public final setPrivateKeyMethod(Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;)V
    ...
    iget-object p0, p0, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->engines:Ljava/util/concurrent/ConcurrentMap;

    invoke-direct {v3, p0, p1}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$PrivateKeyMethod;-><init>(Ljava/util/Map;Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;)V
