...
.method public constructor <init>(Ljavax/net/ssl/SSLContext;ZLjava/lang/Iterable;Lio/netty/handler/ssl/CipherSuiteFilter;Lio/netty/handler/ssl/JdkApplicationProtocolNegotiator;Lio/netty/handler/ssl/ClientAuth;[Ljava/lang/String;ZLjava/lang/String;Ljava/util/List;Lio/netty/handler/ssl/ResumptionController;)V
    ...
    invoke-direct {p0, p8, p11}, Lio/netty/handler/ssl/SslContext;-><init>(ZLio/netty/handler/ssl/ResumptionController;)V
    ...
    iput-object p10, p0, Lio/netty/handler/ssl/JdkSslContext;->serverNames:Ljava/util/List;
...
.method private configureAndWrapEngine(Ljavax/net/ssl/SSLEngine;Lio/netty/buffer/ByteBufAllocator;)Ljavax/net/ssl/SSLEngine;
    ...
    :cond_0
    const-string p1, "Unexpected auth "
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, p1}, Lio/netty/handler/ssl/JdkSslContext;->configureSSLParameters(Ljavax/net/ssl/SSLEngine;)V
...
.method private configureSSLParameters(Ljavax/net/ssl/SSLEngine;)V
    .locals 2
    ...
    iget-object v1, p0, Lio/netty/handler/ssl/JdkSslContext;->serverNames:Ljava/util/List;
    ...
    iget-object p0, p0, Lio/netty/handler/ssl/JdkSslContext;->serverNames:Ljava/util/List;
...
.method public static toNegotiator(Lio/netty/handler/ssl/ApplicationProtocolConfig;Z)Lio/netty/handler/ssl/JdkApplicationProtocolNegotiator;
    ...
    const-string v3, "JDK provider does not support "
    ...
    const-string v5, " failure behavior"
    ...
    invoke-direct {p1, v0, p0}, Lio/netty/handler/ssl/JdkAlpnApplicationProtocolNegotiator;-><init>(ZLjava/lang/Iterable;)V
    ...
    invoke-static {v3, p0, v5}, Ln92;->i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v3, p0, p1}, Ln92;->i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
