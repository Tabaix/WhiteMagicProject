...
.method public constructor <init>(Lio/netty/handler/ssl/SslHandler;Z)V
    ...
    new-instance p1, Lio/netty/handler/ssl/e;

    const/4 v0, 0x1

    invoke-direct {p1, v0}, Lio/netty/handler/ssl/e;-><init>(I)V

    iput-object p0, p1, Lio/netty/handler/ssl/e;->f:Lio/netty/handler/ssl/SslHandler$SslTasksRunner;
...
.method public static synthetic a(Lio/netty/handler/ssl/SslHandler$SslTasksRunner;Ljava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/handler/ssl/SslHandler$SslTasksRunner;->lambda$handleException$0(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic b(Lio/netty/handler/ssl/SslHandler$SslTasksRunner;)V
    .locals 0
...
.method private handleException(Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v2}, Lio/netty/handler/ssl/SslHandler;->access$1200(Lio/netty/handler/ssl/SslHandler;I)V
    ...
    invoke-direct {v1, v3}, Lio/netty/handler/ssl/d;-><init>(I)V
...
.method private synthetic lambda$handleException$0(Ljava/lang/Throwable;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Lio/netty/handler/ssl/SslHandler;->access$1200(Lio/netty/handler/ssl/SslHandler;I)V
...
.method private resumeOnEventExecutor()V
    ...
    sget-object v1, Lio/netty/handler/ssl/SslHandler$2;->$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus:[I
    ...
    invoke-static {v0, v1}, Lio/netty/handler/ssl/SslHandler;->access$1600(Lio/netty/handler/ssl/SslHandler;Lio/netty/channel/ChannelHandlerContext;)I
    :try_end_1
    ...
    invoke-static {v0, v1, v2}, Lio/netty/handler/ssl/SslHandler;->access$1700(Lio/netty/handler/ssl/SslHandler;Lio/netty/channel/ChannelHandlerContext;Z)Z
    ...
    invoke-static {v0, p0}, Lio/netty/handler/ssl/SslHandler;->access$1300(Lio/netty/handler/ssl/SslHandler;Lio/netty/handler/ssl/SslHandler$SslTasksRunner;)V
    :try_end_6
...
.method private taskError(Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v0, p1}, Lio/netty/handler/ssl/SslHandler;->access$800(Lio/netty/handler/ssl/SslHandler;Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v0, p1}, Lio/netty/handler/ssl/SslHandler;->access$900(Lio/netty/handler/ssl/SslHandler;Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)V
...
.method public runComplete()V
    ...
    :cond_0
    new-instance v1, Lio/netty/handler/ssl/e;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lio/netty/handler/ssl/e;-><init>(I)V

    iput-object p0, v1, Lio/netty/handler/ssl/e;->f:Lio/netty/handler/ssl/SslHandler$SslTasksRunner;
