...
.field private final serverNames:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method private constructor <init>(Z)V
    ...
    sget-object v0, Lio/netty/handler/ssl/SslContext;->defaultEndpointVerificationAlgorithm:Ljava/lang/String;

    iput-object v0, p0, Lio/netty/handler/ssl/SslContextBuilder;->endpointIdentificationAlgorithm:Ljava/lang/String;
    ...
    :goto_0
    iput-object p1, p0, Lio/netty/handler/ssl/SslContextBuilder;->serverNames:Ljava/util/List;
...
# virtual methods
.method public addCredential(Lio/netty/handler/ssl/OpenSslCredential;)Lio/netty/handler/ssl/SslContextBuilder;
    .locals 1
    ...
    iget-object v0, p0, Lio/netty/handler/ssl/SslContextBuilder;->credentials:Ljava/util/List;
    ...
    iput-object v0, p0, Lio/netty/handler/ssl/SslContextBuilder;->credentials:Ljava/util/List;
...
.method public addCredentials(Ljava/lang/Iterable;)Lio/netty/handler/ssl/SslContextBuilder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lio/netty/handler/ssl/OpenSslCredential;
    ...
    check-cast v0, Lio/netty/handler/ssl/OpenSslCredential;

    iget-object v1, p0, Lio/netty/handler/ssl/SslContextBuilder;->credentials:Ljava/util/List;
...
.method public varargs addCredentials([Lio/netty/handler/ssl/OpenSslCredential;)Lio/netty/handler/ssl/SslContextBuilder;
    .locals 2

    .line 61
    const-string v0, "credentials"

    invoke-static {v0, p1}, Lio/netty/util/internal/ObjectUtil;->deepCheckNotNull(Ljava/lang/String;[Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public build()Lio/netty/handler/ssl/SslContext;
    ...
    iget-object v0, v0, Lio/netty/handler/ssl/SslContextBuilder;->credentials:Ljava/util/List;
    ...
    iget-object v1, v0, Lio/netty/handler/ssl/SslContextBuilder;->serverNames:Ljava/util/List;
...
.method public keyManager(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Lio/netty/handler/ssl/SslContextBuilder;
    ...
    invoke-static {p1, p2, p0}, Lx74;->k(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, p1, p0}, Lx74;->k(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public keyManager(Ljava/io/InputStream;Ljava/io/InputStream;Ljava/lang/String;)Lio/netty/handler/ssl/SslContextBuilder;
    ...
    .line 64
    const-string p1, "Input stream does not contain valid private key."
    ...
    .line 65
    const-string p1, "Input stream not contain valid certificates."
...
.method public serverName(Ljavax/net/ssl/SNIServerName;)Lio/netty/handler/ssl/SslContextBuilder;
    .locals 2
    ...
    iget-object v0, p0, Lio/netty/handler/ssl/SslContextBuilder;->serverNames:Ljava/util/List;
    ...
    const-string p1, "Only SNIHostName is supported. The given SNIServerName type was "
    ...
    :cond_1
    const-string p0, "Cannot add Server Name Indication extension, because this is a server context builder."
...
.method public trustManager(Ljava/io/File;)Lio/netty/handler/ssl/SslContextBuilder;
    ...
    invoke-static {v0, p1, p0}, Lx74;->k(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public trustManager(Ljava/io/InputStream;)Lio/netty/handler/ssl/SslContextBuilder;
    ...
    .line 18
    const-string p1, "Input stream does not contain valid certificates."
