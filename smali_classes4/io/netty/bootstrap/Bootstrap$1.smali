...
.method public constructor <init>(Ljava/net/SocketAddress;Lio/netty/channel/Channel;Ljava/net/SocketAddress;Lio/netty/channel/ChannelPromise;)V
    ...
    iput-object p1, p0, Lio/netty/bootstrap/Bootstrap$1;->val$localAddress:Ljava/net/SocketAddress;

    iput-object p2, p0, Lio/netty/bootstrap/Bootstrap$1;->val$channel:Lio/netty/channel/Channel;

    iput-object p3, p0, Lio/netty/bootstrap/Bootstrap$1;->val$remoteAddress:Ljava/net/SocketAddress;

    iput-object p4, p0, Lio/netty/bootstrap/Bootstrap$1;->val$connectPromise:Lio/netty/channel/ChannelPromise;
...
.method public run()V
    ...
    iget-object v1, p0, Lio/netty/bootstrap/Bootstrap$1;->val$channel:Lio/netty/channel/Channel;

    if-nez v0, :cond_0

    iget-object v0, p0, Lio/netty/bootstrap/Bootstrap$1;->val$remoteAddress:Ljava/net/SocketAddress;

    iget-object v2, p0, Lio/netty/bootstrap/Bootstrap$1;->val$connectPromise:Lio/netty/channel/ChannelPromise;

    invoke-interface {v1, v0, v2}, Lio/netty/channel/Channel;->connect(Ljava/net/SocketAddress;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;

    goto :goto_0

    :cond_0
    iget-object v2, p0, Lio/netty/bootstrap/Bootstrap$1;->val$remoteAddress:Ljava/net/SocketAddress;

    iget-object v3, p0, Lio/netty/bootstrap/Bootstrap$1;->val$connectPromise:Lio/netty/channel/ChannelPromise;
    ...
    :goto_0
    iget-object p0, p0, Lio/netty/bootstrap/Bootstrap$1;->val$connectPromise:Lio/netty/channel/ChannelPromise;
