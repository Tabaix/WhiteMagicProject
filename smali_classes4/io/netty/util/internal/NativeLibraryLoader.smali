...
.method static constructor <clinit>()V
    ...
    const-string v3, "Custom native workdir mkdirs failed: "
...
.method private static calculateMangledPackagePrefix()Ljava/lang/String;
    ...
    invoke-static {v5, v1, v3, v0, v4}, Lg2;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static digest(Ljava/security/MessageDigest;Ljava/net/URL;)[B
    ...
    const-string v0, "Can\'t read resource."
...
.method private static getResource(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/net/URL;
    ...
    invoke-static {v4, v2}, Lio/netty/util/internal/NativeLibraryLoader;->digest(Ljava/security/MessageDigest;Ljava/net/URL;)[B
    ...
    invoke-static {v4, v8}, Lio/netty/util/internal/NativeLibraryLoader;->digest(Ljava/security/MessageDigest;Ljava/net/URL;)[B
    ...
    const-string v3, "Don\'t support SHA-256, can\'t check if resources have same content."

    invoke-interface {v2, v3, v1}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_2
    invoke-static {v6, p0, v5, p1}, Ln92;->u(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static load(Ljava/lang/String;Ljava/lang/ClassLoader;)V
    ...
    invoke-static {v1, p0}, Lg2;->C(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v5}, Lg2;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, p0}, Lio/netty/util/internal/NativeLibraryLoader;->tryPatchShadedLibraryIdAndSign(Ljava/io/File;Ljava/lang/String;)V
    :try_end_4
    ...
    const-string p1, " exists but cannot be executed even when execute permissions set; check volume for \"noexec\" flag; use -D"

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, "=[path] to set native working directory separately."
    ...
    invoke-interface {v0, p1}, Lio/netty/util/internal/logging/InternalLogger;->info(Ljava/lang/String;)V

    new-instance v0, Ljava/lang/UnsatisfiedLinkError;

    invoke-direct {v0, p1}, Ljava/lang/UnsatisfiedLinkError;-><init>(Ljava/lang/String;)V

    const-class p1, Lio/netty/util/internal/NativeLibraryLoader;
...
.method private static loadLibrary(Ljava/lang/ClassLoader;Ljava/lang/String;Z)V
    ...
    invoke-direct {p2, p1, p0}, Ljava/lang/LinkageError;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static tryPatchShadedLibraryIdAndSign(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1}, Lg2;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
