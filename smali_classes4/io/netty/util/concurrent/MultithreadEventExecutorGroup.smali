...
.method public varargs constructor <init>(ILjava/util/concurrent/Executor;Lio/netty/util/concurrent/EventExecutorChooserFactory;[Ljava/lang/Object;)V
    ...
    iput-object p0, p1, Lkd4;->f:Ljava/lang/Object;
...
.method public static synthetic d(Lio/netty/util/concurrent/MultithreadEventExecutorGroup;Lio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->lambda$new$0(Lio/netty/util/concurrent/Future;)V

    return-void
.end method

.method private synthetic lambda$new$0(Lio/netty/util/concurrent/Future;)V
    .locals 1

    iget-object p1, p0, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->terminatedChildren:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public activeExecutorCount()I
    ...
    instance-of v1, v0, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;

    if-eqz v1, :cond_0

    check-cast v0, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;

    invoke-interface {v0}, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;->activeExecutorCount()I
    ...
    :cond_0
    invoke-virtual {p0}, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->executorCount()I
...
.method public executorUtilizations()Ljava/util/List;
    ...
    instance-of v0, p0, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;

    if-eqz v0, :cond_0

    check-cast p0, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;

    invoke-interface {p0}, Lio/netty/util/concurrent/EventExecutorChooserFactory$ObservableEventExecutorChooser;->executorUtilizations()Ljava/util/List;
