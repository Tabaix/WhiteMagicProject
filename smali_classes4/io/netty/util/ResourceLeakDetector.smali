...
.field private static final DEFAULT_TRACK_CLOSE:Z = true
...
.field private static final PROP_TRACK_CLOSE:Ljava/lang/String; = "io.netty.leakDetection.trackClose"

.field static final SAMPLING_INTERVAL:I

.field private static final TARGET_RECORDS:I

.field private static final TRACK_CLOSE:Z
...
.method static constructor <clinit>()V
    ...
    const-string v4, "io.netty.leakDetection.trackClose"
    ...
    sput-boolean v4, Lio/netty/util/ResourceLeakDetector;->TRACK_CLOSE:Z
...
.method public static synthetic access$500()Z
    ...
    sget-boolean v0, Lio/netty/util/ResourceLeakDetector;->TRACK_CLOSE:Z

    return v0
.end method

.method public static synthetic access$700()Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
...
.method private reportLeak()V
    ...
    :cond_3
    invoke-virtual {p0, v2, v0}, Lio/netty/util/ResourceLeakDetector;->reportTracedLeak(Ljava/lang/String;Ljava/lang/String;)V
...
.method private track0(Ljava/lang/Object;Z)Lio/netty/util/ResourceLeakDetector$DefaultResourceLeak;
    ...
    invoke-direct {p2, p1, v0, v1, p0}, Lio/netty/util/ResourceLeakDetector$DefaultResourceLeak;-><init>(Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;Ljava/util/Set;Ljava/lang/Object;)V
...
.method public isRecordEnabled()Z
    ...
    sget-object v0, Lio/netty/util/ResourceLeakDetector$Level;->ADVANCED:Lio/netty/util/ResourceLeakDetector$Level;
    ...
    :cond_0
    sget p0, Lio/netty/util/ResourceLeakDetector;->TARGET_RECORDS:I
...
.method public track(Ljava/lang/Object;)Lio/netty/util/ResourceLeakTracker;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)",
