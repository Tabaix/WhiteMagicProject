...
.method public static synthetic c(Lio/netty/resolver/AddressResolverGroup;Lio/netty/util/concurrent/EventExecutor;Lio/netty/resolver/AddressResolver;Lio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/netty/resolver/AddressResolverGroup;->lambda$getResolver$0(Lio/netty/util/concurrent/EventExecutor;Lio/netty/resolver/AddressResolver;Lio/netty/util/concurrent/Future;)V

    return-void
.end method

.method private synthetic lambda$getResolver$0(Lio/netty/util/concurrent/EventExecutor;Lio/netty/resolver/AddressResolver;Lio/netty/util/concurrent/Future;)V
    .locals 1

    iget-object p3, p0, Lio/netty/resolver/AddressResolverGroup;->resolvers:Ljava/util/Map;
    ...
    invoke-interface {p2}, Lio/netty/resolver/AddressResolver;->close()V
...
.method public getResolver(Lio/netty/util/concurrent/EventExecutor;)Lio/netty/resolver/AddressResolver;
    ...
    invoke-direct {v2, v3}, Lw7;-><init>(I)V

    iput-object p0, v2, Lw7;->f:Ljava/lang/Object;

    iput-object p1, v2, Lw7;->i:Ljava/lang/Object;

    iput-object v1, v2, Lw7;->n:Ljava/lang/Object;
    ...
    :cond_1
    const-string p0, "executor not accepting a task"
