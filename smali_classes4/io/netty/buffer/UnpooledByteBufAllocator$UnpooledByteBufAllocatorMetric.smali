...
# instance fields
.field final directCounter:Ljava/util/concurrent/atomic/LongAdder;

.field final heapCounter:Ljava/util/concurrent/atomic/LongAdder;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lio/netty/buffer/UnpooledByteBufAllocator$UnpooledByteBufAllocatorMetric;->directCounter:Ljava/util/concurrent/atomic/LongAdder;

    new-instance v0, Ljava/util/concurrent/atomic/LongAdder;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/LongAdder;-><init>()V

    iput-object v0, p0, Lio/netty/buffer/UnpooledByteBufAllocator$UnpooledByteBufAllocatorMetric;->heapCounter:Ljava/util/concurrent/atomic/LongAdder;
...
.method public usedDirectMemory()J
    ...
    iget-object p0, p0, Lio/netty/buffer/UnpooledByteBufAllocator$UnpooledByteBufAllocatorMetric;->directCounter:Ljava/util/concurrent/atomic/LongAdder;
...
.method public usedHeapMemory()J
    ...
    iget-object p0, p0, Lio/netty/buffer/UnpooledByteBufAllocator$UnpooledByteBufAllocatorMetric;->heapCounter:Ljava/util/concurrent/atomic/LongAdder;
