...
.method private static copiedBufferUtf8(Ljava/lang/CharSequence;)Lio/netty/buffer/ByteBuf;
    ...
    :try_start_0
    invoke-static {v1, p0, v0}, Lio/netty/buffer/ByteBufUtil;->reserveAndWriteUtf8(Lio/netty/buffer/ByteBuf;Ljava/lang/CharSequence;I)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static newReadyOnlyBuffer(Lio/netty/buffer/ByteBuf;)Lio/netty/buffer/ReadOnlyByteBuf;
    .locals 1
    ...
    instance-of v0, v0, Lio/netty/buffer/AbstractByteBuf;

    if-eqz v0, :cond_1

    :cond_0
    new-instance v0, Lio/netty/buffer/ReadOnlyAbstractByteBuf;

    check-cast p0, Lio/netty/buffer/AbstractByteBuf;

    invoke-direct {v0, p0}, Lio/netty/buffer/ReadOnlyAbstractByteBuf;-><init>(Lio/netty/buffer/AbstractByteBuf;)V
...
.method public static unmodifiableBuffer(Lio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;
    ...
    invoke-static {p0}, Lio/netty/buffer/Unpooled;->newReadyOnlyBuffer(Lio/netty/buffer/ByteBuf;)Lio/netty/buffer/ReadOnlyByteBuf;
    ...
    sget-object v0, Lio/netty/buffer/Unpooled;->LITTLE_ENDIAN:Ljava/nio/ByteOrder;

    invoke-virtual {p0, v0}, Lio/netty/buffer/AbstractByteBuf;->order(Ljava/nio/ByteOrder;)Lio/netty/buffer/ByteBuf;
