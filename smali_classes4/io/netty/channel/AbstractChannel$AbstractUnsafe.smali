...
.method public static synthetic access$300(Lio/netty/channel/AbstractChannel$AbstractUnsafe;Lio/netty/channel/ChannelPromise;)V
    .locals 0
...
.method public static synthetic c(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    ...
    invoke-static {p0, p1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->lambda$close$1(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
...
.method public static synthetic d(Lio/netty/channel/AbstractChannel$AbstractUnsafe;Lio/netty/channel/ChannelPromise;ZLio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->lambda$register0$0(Lio/netty/channel/ChannelPromise;ZLio/netty/util/concurrent/Future;)V
...
.method private deregister(Lio/netty/channel/ChannelPromise;Z)V
    ...
    invoke-direct {v0, p0, p2, p1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe$6;-><init>(Lio/netty/channel/AbstractChannel$AbstractUnsafe;ZLio/netty/channel/ChannelPromise;)V
...
.method private doClose0(Lio/netty/channel/ChannelPromise;)V
    ...
    invoke-static {v0}, Lio/netty/channel/AbstractChannel;->access$500(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/AbstractChannel$CloseFuture;
    ...
    invoke-static {v1}, Lio/netty/channel/AbstractChannel;->access$500(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/AbstractChannel$CloseFuture;
...
.method private invokeLater(Ljava/lang/Runnable;)V
    ...
    invoke-static {}, Lio/netty/channel/AbstractChannel;->access$400()Lio/netty/util/internal/logging/InternalLogger;
...
.method private static synthetic lambda$close$1(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    .locals 0
...
.method private synthetic lambda$register0$0(Lio/netty/channel/ChannelPromise;ZLio/netty/util/concurrent/Future;)V
    .locals 1
    ...
    iput-boolean p3, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->neverRegistered:Z

    iget-object p3, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->this$0:Lio/netty/channel/AbstractChannel;

    const/4 v0, 0x1

    invoke-static {p3, v0}, Lio/netty/channel/AbstractChannel;->access$002(Lio/netty/channel/AbstractChannel;Z)Z

    iget-object p3, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->this$0:Lio/netty/channel/AbstractChannel;

    invoke-static {p3}, Lio/netty/channel/AbstractChannel;->access$200(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/DefaultChannelPipeline;

    move-result-object p3

    invoke-virtual {p3}, Lio/netty/channel/DefaultChannelPipeline;->invokeHandlerAddedIfNeeded()V

    invoke-virtual {p0, p1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->safeSetSuccess(Lio/netty/channel/ChannelPromise;)V

    iget-object p1, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->this$0:Lio/netty/channel/AbstractChannel;

    invoke-static {p1}, Lio/netty/channel/AbstractChannel;->access$200(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/DefaultChannelPipeline;

    move-result-object p1

    invoke-virtual {p1}, Lio/netty/channel/DefaultChannelPipeline;->fireChannelRegistered()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-interface {p2}, Lio/netty/channel/Channel;->newPromise()Lio/netty/channel/ChannelPromise;

    move-result-object p2

    invoke-virtual {p0, p2}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->close(Lio/netty/channel/ChannelPromise;)V

    iget-object p2, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->this$0:Lio/netty/channel/AbstractChannel;

    invoke-static {p2}, Lio/netty/channel/AbstractChannel;->access$500(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/AbstractChannel$CloseFuture;
...
.method private register0(Lio/netty/channel/ChannelPromise;)V
    ...
    iget-boolean v1, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->neverRegistered:Z
    ...
    iput-object p0, v2, Lw;->i:Ljava/lang/Object;

    iput-object p1, v2, Lw;->n:Lio/netty/channel/ChannelFuture;

    iput-boolean v1, v2, Lw;->f:Z
    ...
    invoke-virtual {p0, v0}, Lio/netty/channel/AbstractChannel;->doRegister(Lio/netty/channel/ChannelPromise;)V
...
.method private shutdownOutput(Lio/netty/channel/ChannelPromise;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1}, Lio/netty/channel/AbstractChannel;->access$200(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/DefaultChannelPipeline;
...
.method public close(Lio/netty/channel/ChannelPromise;)V
    ...
    .line 136
    invoke-virtual {p0, p1, v0, v0}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->close(Lio/netty/channel/ChannelPromise;Ljava/lang/Throwable;Ljava/nio/channels/ClosedChannelException;)V

    return-void
.end method

.method public close(Lio/netty/channel/ChannelPromise;Ljava/lang/Throwable;Ljava/nio/channels/ClosedChannelException;)V
    .locals 10
    ...
    invoke-static {p0}, Lio/netty/channel/AbstractChannel;->access$500(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/AbstractChannel$CloseFuture;

    move-result-object p0

    new-instance p2, Lv;

    invoke-direct {p2, v2}, Lv;-><init>(I)V

    iput-object p1, p2, Lv;->f:Lio/netty/channel/ChannelPromise;

    invoke-static {}, Ljava/lang/invoke/VarHandle;->storeStoreFence()V

    invoke-virtual {p0, p2}, Lio/netty/channel/DefaultChannelPromise;->addListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelPromise;
    ...
    invoke-static {v1, v0}, Lio/netty/channel/AbstractChannel;->access$802(Lio/netty/channel/AbstractChannel;Z)Z
    ...
    iget-object v6, p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->outboundBuffer:Lio/netty/channel/ChannelOutboundBuffer;
    ...
    invoke-direct/range {v3 .. v9}, Lio/netty/channel/AbstractChannel$AbstractUnsafe$4;-><init>(Lio/netty/channel/AbstractChannel$AbstractUnsafe;Lio/netty/channel/ChannelPromise;Lio/netty/channel/ChannelOutboundBuffer;Ljava/lang/Throwable;Ljava/nio/channels/ClosedChannelException;Z)V
    ...
    :try_start_0
    invoke-direct {v4, v5}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->doClose0(Lio/netty/channel/ChannelPromise;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eqz v6, :cond_5

    invoke-virtual {v6, v7, v2}, Lio/netty/channel/ChannelOutboundBuffer;->failFlushed(Ljava/lang/Throwable;Z)V

    invoke-virtual {v6, v8}, Lio/netty/channel/ChannelOutboundBuffer;->close(Ljava/nio/channels/ClosedChannelException;)V

    :cond_5
    iget-boolean p0, v4, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->inFlush0:Z

    if-eqz p0, :cond_6

    new-instance p0, Lio/netty/channel/AbstractChannel$AbstractUnsafe$5;

    invoke-direct {p0, v4, v9}, Lio/netty/channel/AbstractChannel$AbstractUnsafe$5;-><init>(Lio/netty/channel/AbstractChannel$AbstractUnsafe;Z)V

    invoke-direct {v4, p0}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->invokeLater(Ljava/lang/Runnable;)V

    return-void

    :cond_6
    invoke-direct {v4, v9}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->fireChannelInactiveAndDeregister(Z)V
...
.method public final handleWriteError(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, v1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->newClosedChannelException(Ljava/lang/Throwable;Ljava/lang/String;)Ljava/nio/channels/ClosedChannelException;

    move-result-object v1

    invoke-virtual {p0, v0, p1, v1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->close(Lio/netty/channel/ChannelPromise;Ljava/lang/Throwable;Ljava/nio/channels/ClosedChannelException;)V
    ...
    invoke-static {v2, p1}, Lio/netty/channel/AbstractChannel;->access$1202(Lio/netty/channel/AbstractChannel;Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, v2, v0, p1}, Lio/netty/channel/AbstractChannel$AbstractUnsafe;->close(Lio/netty/channel/ChannelPromise;Ljava/lang/Throwable;Ljava/nio/channels/ClosedChannelException;)V
...
.method public final register(Lio/netty/channel/EventLoop;Lio/netty/channel/ChannelPromise;)V
    ...
    invoke-static {v0}, Lio/netty/channel/AbstractChannel;->access$200(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/DefaultChannelPipeline;

    move-result-object v0

    iget-object v0, v0, Lio/netty/channel/DefaultChannelPipeline;->tail:Lio/netty/channel/DefaultChannelPipeline$TailContext;

    :cond_2
    const/4 v1, 0x0

    iput-object v1, v0, Lio/netty/channel/AbstractChannelHandlerContext;->contextExecutor:Lio/netty/util/concurrent/EventExecutor;
...
.method public final voidPromise()Lio/netty/channel/ChannelPromise;
    ...
    invoke-static {p0}, Lio/netty/channel/AbstractChannel;->access$1300(Lio/netty/channel/AbstractChannel;)Lio/netty/channel/VoidChannelPromise;
