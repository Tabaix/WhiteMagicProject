...
.method private ensureBound()V
    ...
    :cond_0
    const-class p0, Lio/netty/channel/socket/DatagramChannel;

    invoke-virtual {p0}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object p0

    const-string v0, " must be bound to join a group."
...
.method public block(Ljava/net/InetAddress;Ljava/net/InetAddress;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/Channel;->newFailedFuture(Ljava/lang/Throwable;)Lio/netty/channel/ChannelFuture;
...
.method public doWrite(Lio/netty/channel/ChannelOutboundBuffer;)V
    ...
    invoke-virtual {v2, v1, v4, v3}, Ljava/net/DatagramPacket;->setData([BII)V
    ...
    invoke-static {v0, v1, v3}, Lio/netty/buffer/ByteBufUtil;->getBytes(Lio/netty/buffer/ByteBuf;II)[B
...
.method public filterOutboundMessage(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast p0, Lio/netty/channel/socket/DatagramPacket;

    invoke-static {p0}, Lio/netty/channel/socket/oio/OioDatagramChannel;->checkUnresolved(Lio/netty/channel/AddressedEnvelope;)V
