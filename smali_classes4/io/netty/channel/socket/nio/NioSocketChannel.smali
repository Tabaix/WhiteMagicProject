...
.method public constructor <init>(Ljava/nio/channels/spi/SelectorProvider;)V
    ...
    .line 16
    invoke-direct {p0, p1, v0}, Lio/netty/channel/socket/nio/NioSocketChannel;-><init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)V
...
.method public constructor <init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/InternetProtocolFamily;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, Lio/netty/channel/socket/nio/NioSocketChannel;-><init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)V
...
.method public constructor <init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)V
    ...
    .line 18
    invoke-static {p1, p2}, Lio/netty/channel/socket/nio/NioSocketChannel;->newChannel(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/SocketChannel;
...
.method private static newChannel(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/SocketChannel;
    .locals 1

    :try_start_0
    sget-object v0, Lio/netty/channel/socket/nio/NioSocketChannel;->OPEN_SOCKET_CHANNEL_WITH_FAMILY:Ljava/lang/reflect/Method;

    invoke-static {v0, p0, p1}, Lio/netty/channel/socket/nio/SelectorProviderUtil;->newChannel(Ljava/lang/reflect/Method;Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/Channel;
...
.method public doConnect(Ljava/net/SocketAddress;Ljava/net/SocketAddress;)Z
    ...
    invoke-virtual {p0, p2}, Lio/netty/channel/nio/AbstractNioChannel;->addAndSubmit(Lio/netty/channel/nio/NioIoOps;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public doFinishConnect()V
    ...
    const-string v0, "finishConnect is not supported for "
