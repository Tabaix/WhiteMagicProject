...
.method public constructor <init>(Lio/netty/channel/socket/InternetProtocolFamily;)V
    ...
    .line 14
    :cond_0
    invoke-virtual {p1}, Lio/netty/channel/socket/InternetProtocolFamily;->toSocketProtocolFamily()Lio/netty/channel/socket/SocketProtocolFamily;

    move-result-object p1

    :goto_0
    invoke-direct {p0, p1}, Lio/netty/channel/socket/nio/NioDatagramChannel;-><init>(Lio/netty/channel/socket/SocketProtocolFamily;)V
...
.method public constructor <init>(Lio/netty/channel/socket/SocketProtocolFamily;)V
    ...
    invoke-static {v0, p1}, Lio/netty/channel/socket/nio/NioDatagramChannel;->newSocket(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/DatagramChannel;
...
.method public constructor <init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/InternetProtocolFamily;)V
    ...
    .line 16
    :cond_0
    invoke-virtual {p2}, Lio/netty/channel/socket/InternetProtocolFamily;->toSocketProtocolFamily()Lio/netty/channel/socket/SocketProtocolFamily;

    move-result-object p2

    :goto_0
    invoke-direct {p0, p1, p2}, Lio/netty/channel/socket/nio/NioDatagramChannel;-><init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)V

    return-void
.end method

.method public constructor <init>(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)V
    .locals 0

    .line 17
    invoke-static {p1, p2}, Lio/netty/channel/socket/nio/NioDatagramChannel;->newSocket(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/DatagramChannel;
...
.method private static newSocket(Ljava/nio/channels/spi/SelectorProvider;Lio/netty/channel/socket/SocketProtocolFamily;)Ljava/nio/channels/DatagramChannel;
    .locals 1
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p1}, Lio/netty/channel/socket/SocketProtocolFamily;->toJdkFamily()Ljava/net/ProtocolFamily;
...
.method public doFinishConnect()V
    ...
    const-string v1, "finishConnect is not supported for "
