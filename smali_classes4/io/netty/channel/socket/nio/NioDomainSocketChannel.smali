...
.method public constructor <init>(Lio/netty/channel/Channel;Ljava/nio/channels/SocketChannel;)V
    ...
    :cond_0
    const-string p0, "Only supported on java 16+"
...
.method private adjustMaxBytesPerGatheringWrite(III)V
    ...
    iget-object p0, p0, Lio/netty/channel/socket/nio/NioDomainSocketChannel;->config:Lio/netty/channel/ChannelConfig;

    check-cast p0, Lio/netty/channel/socket/nio/NioDomainSocketChannel$NioDomainSocketChannelConfig;

    invoke-virtual {p0, p1}, Lio/netty/channel/socket/nio/NioDomainSocketChannel$NioDomainSocketChannelConfig;->setMaxBytesPerGatheringWrite(I)V
...
.method public static newChannel(Ljava/nio/channels/spi/SelectorProvider;)Ljava/nio/channels/SocketChannel;
    .locals 3
...
.method public doFinishConnect()V
    ...
    :cond_0
    const-class p0, Lio/netty/channel/socket/nio/NioDomainSocketChannel;
...
.method public bridge synthetic parent()Lio/netty/channel/Channel;
    ...
    .line 7
    invoke-virtual {p0}, Lio/netty/channel/socket/nio/NioDomainSocketChannel;->parent()Lio/netty/channel/ServerChannel;
...
.method public parent()Lio/netty/channel/ServerChannel;
    .locals 0
    ...
    check-cast p0, Lio/netty/channel/ServerChannel;
