...
.method public bridge synthetic addListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/ChannelPromise;->addListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic addListeners([Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/ChannelPromise;->addListeners([Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic await()Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0}, Lio/netty/channel/ChannelPromise;->await()Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic awaitUninterruptibly()Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0}, Lio/netty/channel/ChannelPromise;->awaitUninterruptibly()Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic removeListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/ChannelPromise;->removeListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic removeListeners([Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/ChannelPromise;->removeListeners([Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic setSuccess(Ljava/lang/Object;)Lio/netty/util/concurrent/Promise;
    ...
    invoke-interface {p0, p1}, Lio/netty/channel/ChannelPromise;->setSuccess(Ljava/lang/Void;)Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic sync()Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0}, Lio/netty/channel/ChannelPromise;->sync()Lio/netty/channel/ChannelPromise;
...
.method public bridge synthetic syncUninterruptibly()Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {p0}, Lio/netty/channel/ChannelPromise;->syncUninterruptibly()Lio/netty/channel/ChannelPromise;
