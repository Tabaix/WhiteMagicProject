...
.method private checkAdded()V
    ...
    :cond_0
    const-string p0, "handler not added to pipeline yet"
...
.method private validate(Lio/netty/channel/ChannelInboundHandler;Lio/netty/channel/ChannelOutboundHandler;)V
    ...
    :cond_0
    const-string p0, "outboundHandler must not implement ChannelInboundHandler to get combined."
    ...
    :cond_1
    const-string p0, "inboundHandler must not implement ChannelOutboundHandler to get combined."
    ...
    :cond_2
    const-string p0, "init() can not be invoked if CombinedChannelDuplexHandler was constructed with non-default constructor."
...
.method public handlerAdded(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    :cond_0
    const-string p0, "init() must be invoked before being added to a ChannelPipeline if CombinedChannelDuplexHandler was constructed with the default constructor."
