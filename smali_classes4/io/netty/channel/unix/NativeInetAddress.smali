...
.method public static address([BII)Ljava/net/InetSocketAddress;
    ...
    invoke-static {p0, v2}, Lio/netty/channel/unix/NativeInetAddress;->decodeInt([BI)I
    ...
    :cond_1
    :goto_0
    invoke-static {p1, v0, p0}, Ljava/net/Inet6Address;->getByAddress(Ljava/lang/String;[BI)Ljava/net/Inet6Address;
    ...
    const-string p2, " (allowed: 8 or 24)"
    ...
    invoke-direct {p1, p0, v2}, Ljava/net/InetSocketAddress;-><init>(Ljava/net/InetAddress;I)V
    :try_end_0
