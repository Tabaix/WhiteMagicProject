...
.method public static synthetic a(Lio/netty/channel/DefaultChannelPipeline;Ljava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/channel/DefaultChannelPipeline;->lambda$fireExceptionCaught$0(Ljava/lang/Throwable;)V
...
.method private addLast0(Lio/netty/channel/AbstractChannelHandlerContext;)V
    ...
    iget-object p0, p0, Lio/netty/channel/DefaultChannelPipeline;->tail:Lio/netty/channel/DefaultChannelPipeline$TailContext;
...
.method public static synthetic b(Lio/netty/channel/DefaultChannelPipeline;Ljava/lang/Object;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/channel/DefaultChannelPipeline;->lambda$fireUserEventTriggered$1(Ljava/lang/Object;)V
...
.method private checkDuplicateName(Ljava/lang/String;)V
    ...
    :cond_0
    const-string p0, "Duplicate handler name: "
...
.method public static synthetic d(Lio/netty/channel/DefaultChannelPipeline;Ljava/lang/Object;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/netty/channel/DefaultChannelPipeline;->lambda$fireChannelRead$2(Ljava/lang/Object;)V
...
.method private getContextOrDie(Ljava/lang/String;)Lio/netty/channel/AbstractChannelHandlerContext;
    ...
    .line 23
    :cond_0
    invoke-static {p1}, Lel;->t(Ljava/lang/String;)V
...
.method private internalAdd(Lio/netty/util/concurrent/EventExecutorGroup;Ljava/lang/String;Lio/netty/channel/ChannelHandler;Ljava/lang/String;Lio/netty/channel/DefaultChannelPipeline$AddStrategy;)Lio/netty/channel/ChannelPipeline;
    ...
    const-string v0, "unknown add strategy: "
...
.method private synthetic lambda$fireExceptionCaught$0(Ljava/lang/Throwable;)V
    .locals 0
...
.method private replace(Lio/netty/channel/AbstractChannelHandlerContext;Ljava/lang/String;Lio/netty/channel/ChannelHandler;)Lio/netty/channel/ChannelHandler;
    ...
    :cond_1
    :goto_0
    iget-object v0, p1, Lio/netty/channel/AbstractChannelHandlerContext;->childExecutor:Lio/netty/util/concurrent/EventExecutor;
...
.method public final fireChannelActive()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelActive(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelActive()Lio/netty/channel/ChannelHandlerContext;
    ...
    iput-object p0, v1, Ln91;->f:Lio/netty/channel/DefaultChannelPipeline;
...
.method public final fireChannelInactive()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelInactive(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelInactive()Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireChannelRead(Ljava/lang/Object;)Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1, p1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V

    return-object p0

    :cond_0
    invoke-virtual {v1, p1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelRead(Ljava/lang/Object;)Lio/netty/channel/ChannelHandlerContext;
    ...
    iput-object p0, v1, Lo91;->f:Lio/netty/channel/DefaultChannelPipeline;

    iput-object p1, v1, Lo91;->i:Ljava/lang/Object;
...
.method public final fireChannelReadComplete()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelReadComplete(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelReadComplete()Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireChannelRegistered()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelRegistered(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelRegistered()Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireChannelUnregistered()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelUnregistered(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelUnregistered()Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireChannelWritabilityChanged()Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->channelWritabilityChanged(Lio/netty/channel/ChannelHandlerContext;)V

    return-object p0

    :cond_0
    invoke-virtual {v1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireChannelWritabilityChanged()Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireExceptionCaught(Ljava/lang/Throwable;)Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1, p1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->exceptionCaught(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)V

    return-object p0

    :cond_0
    invoke-virtual {v1, p1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireExceptionCaught(Ljava/lang/Throwable;)Lio/netty/channel/ChannelHandlerContext;
...
.method public final fireUserEventTriggered(Ljava/lang/Object;)Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v1, v1, p1}, Lio/netty/channel/DefaultChannelPipeline$HeadContext;->userEventTriggered(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V

    return-object p0

    :cond_0
    invoke-virtual {v1, p1}, Lio/netty/channel/AbstractChannelHandlerContext;->fireUserEventTriggered(Ljava/lang/Object;)Lio/netty/channel/ChannelHandlerContext;
