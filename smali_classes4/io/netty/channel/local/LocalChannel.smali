...
.field private final finishReadTask:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lio/netty/channel/local/LocalChannel;->finishReadTask:Ljava/lang/Runnable;
...
.method public static synthetic a(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/netty/channel/local/LocalChannel;->lambda$doRegister$0(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
...
.method public static synthetic access$100(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/local/LocalChannel;)V
    .locals 0
...
.method public static synthetic access$400(Lio/netty/channel/local/LocalChannel;)Lio/netty/channel/local/LocalChannel;
    .locals 0
...
.method public static synthetic access$402(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/local/LocalChannel;)Lio/netty/channel/local/LocalChannel;
    .locals 0
...
.method public static synthetic access$502(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/local/LocalChannel$State;)Lio/netty/channel/local/LocalChannel$State;
    .locals 0
...
.method public static synthetic access$602(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/local/LocalAddress;)Lio/netty/channel/local/LocalAddress;
    .locals 0
...
.method public static synthetic access$700(Lio/netty/channel/local/LocalChannel;)Lio/netty/channel/ChannelPromise;
    .locals 0
...
.method public static synthetic access$702(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelPromise;
    .locals 0
...
.method private synthetic lambda$doRegister$0(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    ...
    iput-object p2, p0, Lio/netty/channel/local/LocalChannel;->registration:Lio/netty/channel/IoRegistration;
...
.method private runFinishPeerReadTask(Lio/netty/channel/local/LocalChannel;)V
    ...
    :try_start_0
    invoke-direct {p1}, Lio/netty/channel/local/LocalChannel;->runFinishTask0()V
    :try_end_0
...
.method private runFinishTask0()V
    .locals 2

    iget-boolean v0, p0, Lio/netty/channel/local/LocalChannel;->writeInProgress:Z
    ...
    iget-object v1, p0, Lio/netty/channel/local/LocalChannel;->finishReadTask:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lio/netty/channel/local/LocalChannel;->finishReadFuture:Lio/netty/util/concurrent/Future;
    ...
    iget-object p0, p0, Lio/netty/channel/local/LocalChannel;->finishReadTask:Ljava/lang/Runnable;
...
.method public doClose()V
    ...
    :try_start_1
    new-instance v4, Lio/netty/channel/local/LocalChannel$3;

    invoke-direct {v4, p0, v0, v3}, Lio/netty/channel/local/LocalChannel$3;-><init>(Lio/netty/channel/local/LocalChannel;Lio/netty/channel/local/LocalChannel;Z)V
...
.method public doDeregister()V
    ...
    instance-of v0, v0, Lio/netty/channel/IoEventLoop;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lio/netty/channel/local/LocalChannel;->registration:Lio/netty/channel/IoRegistration;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    iput-object v1, p0, Lio/netty/channel/local/LocalChannel;->registration:Lio/netty/channel/IoRegistration;
    ...
    invoke-virtual {p0}, Lio/netty/channel/local/LocalChannel$LocalUnsafe;->unregistered()V
...
.method public doRegister(Lio/netty/channel/ChannelPromise;)V
    ...
    check-cast v1, Lio/netty/channel/local/LocalChannel$LocalUnsafe;
    ...
    invoke-virtual {p0}, Lio/netty/channel/local/LocalChannel$LocalUnsafe;->registered()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public doWrite(Lio/netty/channel/ChannelOutboundBuffer;)V
    ...
    sget-object v0, Lio/netty/channel/local/LocalChannel$4;->$SwitchMap$io$netty$channel$local$LocalChannel$State:[I
...
.method public isCompatible(Lio/netty/channel/EventLoop;)Z
    ...
    const-class p0, Lio/netty/channel/local/LocalChannel$LocalUnsafe;
