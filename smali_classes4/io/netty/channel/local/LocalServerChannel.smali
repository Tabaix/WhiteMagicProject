...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;
    }
.end annotation
...
.method public static synthetic a(Lio/netty/channel/local/LocalServerChannel;Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/netty/channel/local/LocalServerChannel;->lambda$doRegister$0(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
...
.method private synthetic lambda$doRegister$0(Lio/netty/channel/ChannelPromise;Lio/netty/util/concurrent/Future;)V
    ...
    iput-object p2, p0, Lio/netty/channel/local/LocalServerChannel;->registration:Lio/netty/channel/IoRegistration;
...
.method public doDeregister()V
    ...
    iget-object v0, p0, Lio/netty/channel/local/LocalServerChannel;->registration:Lio/netty/channel/IoRegistration;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    iput-object v1, p0, Lio/netty/channel/local/LocalServerChannel;->registration:Lio/netty/channel/IoRegistration;
    ...
    invoke-virtual {p0}, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;->unregistered()V
...
.method public doRegister(Lio/netty/channel/ChannelPromise;)V
    ...
    check-cast v1, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;
    ...
    invoke-virtual {p0}, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;->registered()V
    :try_end_0
...
.method public isCompatible(Lio/netty/channel/EventLoop;)Z
    ...
    const-class p0, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;
...
.method public newUnsafe()Lio/netty/channel/AbstractChannel$AbstractUnsafe;
    ...
    new-instance v0, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lio/netty/channel/local/LocalServerChannel$LocalServerUnsafe;-><init>(Lio/netty/channel/local/LocalServerChannel;Lio/netty/channel/local/LocalServerChannel$1;)V
