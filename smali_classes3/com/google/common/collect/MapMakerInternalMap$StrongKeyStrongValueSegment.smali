...
.method public bridge synthetic castForTesting(Lpx3;)Lpx3;
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/collect/MapMakerInternalMap$StrongKeyStrongValueSegment;->castForTesting(Lpx3;)Lrx3;
...
.method public castForTesting(Lpx3;)Lrx3;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
