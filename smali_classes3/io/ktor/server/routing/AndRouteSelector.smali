...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "component2",
        "copy",
        "(Lio/ktor/server/routing/RouteSelector;Lio/ktor/server/routing/RouteSelector;)Lio/ktor/server/routing/AndRouteSelector;",
        "hashCode",
        "()I",
        "",
        "other",
...
.method public evaluate(Lio/ktor/server/routing/RoutingResolveContext;ILl11;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p3}, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;-><init>(Lio/ktor/server/routing/AndRouteSelector;Ll11;)V
    ...
    iget-object p0, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->L$1:Ljava/lang/Object;
    ...
    iget-object p3, p0, Lio/ktor/server/routing/AndRouteSelector;->first:Lio/ktor/server/routing/RouteSelector;

    iput-object p1, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->L$0:Ljava/lang/Object;

    iput p2, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->I$0:I

    iput v5, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->label:I
    ...
    instance-of v2, p3, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;
    ...
    iput-object v3, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->L$0:Ljava/lang/Object;

    iput-object p3, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->L$1:Ljava/lang/Object;

    iput p2, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->I$0:I

    iput v4, v0, Lio/ktor/server/routing/AndRouteSelector$evaluate$1;->label:I

    invoke-virtual {p0, p1, v2, v0}, Lio/ktor/server/routing/RouteSelector;->evaluate(Lio/ktor/server/routing/RoutingResolveContext;ILl11;)Ljava/lang/Object;
    ...
    instance-of p1, p3, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;
    ...
    check-cast p3, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;

    invoke-virtual {p3}, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;->getParameters()Lio/ktor/http/Parameters;
    ...
    invoke-virtual {p3}, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;->getQuality()D
    ...
    invoke-virtual {p3}, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;->getSegmentIncrement()I

    move-result p3

    add-int/2addr p3, p0

    invoke-direct {p2, v2, v3, p1, p3}, Lio/ktor/server/routing/RouteSelectorEvaluation$Success;-><init>(DLio/ktor/http/Parameters;I)V
