...
.field public static final synthetic c:[Lorg/slf4j/helpers/Reporter$Level;
...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lorg/slf4j/helpers/Reporter$Level;

    const-string v2, "INFO"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lorg/slf4j/helpers/Reporter$Level;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lorg/slf4j/helpers/Reporter$Level;->INFO:Lorg/slf4j/helpers/Reporter$Level;

    new-instance v2, Lorg/slf4j/helpers/Reporter$Level;

    const-string v3, "WARN"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lorg/slf4j/helpers/Reporter$Level;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lorg/slf4j/helpers/Reporter$Level;->WARN:Lorg/slf4j/helpers/Reporter$Level;

    new-instance v3, Lorg/slf4j/helpers/Reporter$Level;

    const-string v4, "ERROR"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lorg/slf4j/helpers/Reporter$Level;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lorg/slf4j/helpers/Reporter$Level;->ERROR:Lorg/slf4j/helpers/Reporter$Level;

    filled-new-array {v0, v1, v2, v3}, [Lorg/slf4j/helpers/Reporter$Level;

    move-result-object v0

    sput-object v0, Lorg/slf4j/helpers/Reporter$Level;->c:[Lorg/slf4j/helpers/Reporter$Level;
...
.method public static values()[Lorg/slf4j/helpers/Reporter$Level;
    ...
    sget-object v0, Lorg/slf4j/helpers/Reporter$Level;->c:[Lorg/slf4j/helpers/Reporter$Level;
