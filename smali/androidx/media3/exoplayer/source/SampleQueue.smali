...
.field private unadjustedUpstreamFormat:Lx62;

.field private upstreamFormat:Lx62;
...
.method public constructor <init>(Landroidx/media3/exoplayer/upstream/Allocator;Landroidx/media3/exoplayer/drm/DrmSessionManager;Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;)V
    ...
    new-array p1, p1, [Lrr6;

    iput-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;
    ...
    invoke-direct {p1, p2}, Landroidx/media3/exoplayer/source/SpannedData;-><init>(Lf01;)V
...
.method private static canDiscardAllSamplesToStartTime(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Ln84;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private declared-synchronized commitSample(JIJILrr6;)V
    .locals 7
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;
    ...
    iget-object p1, p1, Landroidx/media3/exoplayer/source/SampleQueue$SharedSampleMetadata;->format:Lx62;

    iget-object p2, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;

    invoke-virtual {p1, p2}, Lx62;->equals(Ljava/lang/Object;)Z
    ...
    :cond_4
    iget-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;
    ...
    invoke-interface {p2, p3, p1}, Landroidx/media3/exoplayer/drm/DrmSessionManager;->preacquireSession(Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;)Landroidx/media3/exoplayer/drm/DrmSessionManager$DrmSessionReference;
    ...
    invoke-direct {p5, p1, p2, p6}, Landroidx/media3/exoplayer/source/SampleQueue$SharedSampleMetadata;-><init>(Lx62;Landroidx/media3/exoplayer/drm/DrmSessionManager$DrmSessionReference;Landroidx/media3/exoplayer/source/SampleQueue$1;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;
    ...
    iget-object v3, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;
...
.method private onFormatResult(Lx62;Landroidx/media3/exoplayer/FormatHolder;)V
    .locals 5

    iget-object v0, p0, Landroidx/media3/exoplayer/source/SampleQueue;->downstreamFormat:Lx62;
    ...
    :cond_1
    iget-object v0, v0, Lx62;->s:Lhm1;

    :goto_1
    iput-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->downstreamFormat:Lx62;

    iget-object v2, p1, Lx62;->s:Lhm1;
    ...
    invoke-interface {v3, p1}, Landroidx/media3/exoplayer/drm/DrmSessionManager;->getCryptoType(Lx62;)I
    ...
    :goto_2
    iput-object v3, p2, Landroidx/media3/exoplayer/FormatHolder;->format:Lx62;
    ...
    invoke-interface {v1, v2, p1}, Landroidx/media3/exoplayer/drm/DrmSessionManager;->acquireSession(Landroidx/media3/exoplayer/drm/DrmSessionEventListener$EventDispatcher;Lx62;)Landroidx/media3/exoplayer/drm/DrmSession;
...
.method private declared-synchronized peekSampleMetadata(Landroidx/media3/exoplayer/FormatHolder;Lc81;ZZLandroidx/media3/exoplayer/source/SampleQueue$SampleExtrasHolder;)I
    .locals 7
    ...
    :try_start_0
    iput-boolean v0, p2, Lc81;->waitingForKeys:Z
    ...
    iget-object v0, v0, Landroidx/media3/exoplayer/source/SampleQueue$SharedSampleMetadata;->format:Lx62;

    if-nez p3, :cond_6

    iget-object p3, p0, Landroidx/media3/exoplayer/source/SampleQueue;->downstreamFormat:Lx62;
    ...
    iput-boolean v4, p2, Lc81;->waitingForKeys:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p2, p3}, Lg80;->setFlags(I)V
    ...
    invoke-virtual {p2, p3}, Lg80;->addFlag(I)V
    ...
    iget-object p2, p0, Landroidx/media3/exoplayer/source/SampleQueue;->cryptoDatas:[Lrr6;

    aget-object p1, p2, p1

    iput-object p1, p5, Landroidx/media3/exoplayer/source/SampleQueue$SampleExtrasHolder;->cryptoData:Lrr6;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_0
    :try_start_2
    invoke-direct {p0, v0, p1}, Landroidx/media3/exoplayer/source/SampleQueue;->onFormatResult(Lx62;Landroidx/media3/exoplayer/FormatHolder;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-direct {p0, p2, p1}, Landroidx/media3/exoplayer/source/SampleQueue;->onFormatResult(Lx62;Landroidx/media3/exoplayer/FormatHolder;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    :try_start_4
    invoke-virtual {p2, p1}, Lg80;->setFlags(I)V
...
.method private releaseDrmSessionReferences()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/source/SampleQueue;->downstreamFormat:Lx62;
...
.method private declared-synchronized setUpstreamFormat(Lx62;)Z
    .locals 3
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;
    ...
    iget-object v1, v1, Landroidx/media3/exoplayer/source/SampleQueue$SharedSampleMetadata;->format:Lx62;

    invoke-virtual {v1, p1}, Lx62;->equals(Ljava/lang/Object;)Z
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;
    ...
    iget-object v1, v1, Lx62;->k:Ljava/lang/String;

    invoke-static {v2, v1}, Landroidx/media3/exoplayer/source/SampleQueue;->canDiscardAllSamplesToStartTime(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public final format(Lx62;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/source/SampleQueue;->getAdjustedUpstreamFormat(Lx62;)Lx62;
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->unadjustedUpstreamFormat:Lx62;

    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/source/SampleQueue;->setUpstreamFormat(Lx62;)Z
    ...
    invoke-interface {p0, v0}, Landroidx/media3/exoplayer/source/SampleQueue$UpstreamFormatChangedListener;->onUpstreamFormatChanged(Lx62;)V
...
.method public final declared-synchronized getUpstreamFormat()Lx62;
    .locals 1
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public read(Landroidx/media3/exoplayer/FormatHolder;Lc81;IZ)I
    .locals 9
    ...
    invoke-direct/range {v3 .. v8}, Landroidx/media3/exoplayer/source/SampleQueue;->peekSampleMetadata(Landroidx/media3/exoplayer/FormatHolder;Lc81;ZZLandroidx/media3/exoplayer/source/SampleQueue$SampleExtrasHolder;)I
    ...
    invoke-virtual {v5}, Lg80;->isEndOfStream()Z
    ...
    invoke-virtual {p1, v5, p2}, Landroidx/media3/exoplayer/source/SampleDataQueue;->peekToBuffer(Lc81;Landroidx/media3/exoplayer/source/SampleQueue$SampleExtrasHolder;)V
    ...
    invoke-virtual {p1, v5, p2}, Landroidx/media3/exoplayer/source/SampleDataQueue;->readToBuffer(Lc81;Landroidx/media3/exoplayer/source/SampleQueue$SampleExtrasHolder;)V
...
.method public final sampleData(Lp61;IZI)I
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/source/SampleDataQueue;->sampleData(Lp61;IZ)I
...
.method public final sampleData(Lgu4;II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/exoplayer/source/SampleDataQueue;->sampleData(Lgu4;I)V
...
.method public sampleMetadata(JIIILrr6;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/SampleQueue;->unadjustedUpstreamFormat:Lx62;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p0, v1}, Landroidx/media3/exoplayer/source/SampleQueue;->format(Lx62;)V
    ...
    iget-object v7, p0, Landroidx/media3/exoplayer/source/SampleQueue;->upstreamFormat:Lx62;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/media3/exoplayer/source/SampleQueue;->commitSample(JIJILrr6;)V
...
.method public final declared-synchronized seekTo(JZ)Z
    ...
    iget-wide v4, p0, Landroidx/media3/exoplayer/source/SampleQueue;->largestQueuedTimestampUs:J
