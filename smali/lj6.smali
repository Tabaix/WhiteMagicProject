...
.method public final a()Landroid/graphics/Canvas;
    ...
    iget-object p0, p0, Llj6;->a:Landroid/graphics/Canvas;
    ...
    invoke-static {p0}, Lmv2;->d(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    invoke-virtual {p0}, Llj6;->a()Landroid/graphics/Canvas;

    move-result-object p0

    invoke-static {p0, p1}, Lbo;->o(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lbo;->p(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lbo;->q(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1}, Lbo;->r(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Lbo;->s(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    invoke-static {p0}, Lws;->A(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2}, Lws;->C(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {p0, p1, p2}, Lws;->D(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lws;->E(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p7}, Lws;->F(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p5}, Lws;->G(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p7}, Leh0;->K(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Leh0;->L(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Leh0;->M(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    invoke-static {p0, p1}, Lws;->H(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 11
    invoke-static/range {p0 .. p9}, Lws;->I(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    invoke-static {p0}, Lws;->J(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lj90;->M(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {p0, p1}, Lj90;->N(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Lj90;->O(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
