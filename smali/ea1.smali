...
# static fields
.field public static final A:Lea1;
...
.method public final B(JLjava/lang/Runnable;Lk31;)Lhj1;
    ...
    new-instance p4, Lfu1;

    add-long/2addr v0, p1

    invoke-direct {p4, v0, v1}, Lgu1;-><init>(J)V

    iput-object p3, p4, Lfu1;->i:Ljava/lang/Runnable;

    invoke-static {}, Ljava/lang/invoke/VarHandle;->storeStoreFence()V

    invoke-virtual {p0, p1, p2, p4}, Liu1;->f0(JLgu1;)V
...
.method public final W(Ljava/lang/Runnable;)V
    ...
    sget v0, Lea1;->debugStatus:I

    const/4 v1, 0x4

    if-eq v0, v1, :cond_0

    invoke-super {p0, p1}, Liu1;->W(Ljava/lang/Runnable;)V
...
.method public final a0()Ljava/lang/Thread;
    ...
    sget-object v0, Lea1;->_thread:Ljava/lang/Thread;
    ...
    sput-object v0, Lea1;->_thread:Ljava/lang/Thread;

    sget-object v1, Lea1;->A:Lea1;
...
.method public final c0(JLgu1;)V
    .locals 0
...
.method public final declared-synchronized i0()V
    ...
    :cond_2
    :try_start_1
    sput v2, Lea1;->debugStatus:I

    invoke-virtual {p0}, Liu1;->e0()V
...
.method public final run()V
    ...
    sput-object v2, Lea1;->_thread:Ljava/lang/Thread;

    invoke-virtual {v1}, Lea1;->i0()V

    invoke-virtual {v1}, Liu1;->b0()Z

    move-result v0

    if-nez v0, :cond_a

    invoke-virtual {v1}, Lea1;->a0()Ljava/lang/Thread;

    return-void

    :cond_2
    :try_start_3
    sput v6, Lea1;->debugStatus:I
...
.method public final shutdown()V
    ...
    sput v0, Lea1;->debugStatus:I

    invoke-super {p0}, Liu1;->shutdown()V
